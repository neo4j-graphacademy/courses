...
* Existence and uniqueness for a  node property value or a set of node property values.
...
It would fail because for the creation of the node with the label Person, the update property has not been set.
