...
----
/*select:CREATE CONSTRAINT Company_taxId_uniqueness IF NOT EXISTS ON (x:Company) ASSERT x.taxId IS UNIQUE*/
----
...
* [x] `CREATE CONSTRAINT Company_taxId_uniqueness IF NOT EXISTS ON (x:Company) ASSERT x.taxId IS UNIQUE`
