...
----
CREATE CONSTRAINT <constraint_name> IF NOT EXISTS ON (x:<node_label>) REQUIRE x.<property_key> IS UNIQUE
----
...
[source,cypher]
----
CREATE CONSTRAINT Movie_year_uniqueness IF NOT EXISTS ON (x:Movie) REQUIRE x.year IS UNIQUE
----
