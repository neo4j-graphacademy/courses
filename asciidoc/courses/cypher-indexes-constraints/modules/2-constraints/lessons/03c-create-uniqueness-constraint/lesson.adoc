...
* *`constraint_name`*: [copy]#Person_tmdbId_uniqueness#
* *`node_label`*: [copy]#Person#
* *`property_key`*: [copy]#Person#

2. For the User nodes:

* *`constraint_name`*: [copy]#User_userId_uniqueness#
* *`node_label`*: [copy]#User#
* *`property_key`*: [copy]#userId#

3. For the Genre nodes:

* *`constraint_name`*: [copy]#Genre_name_uniqueness#
