...
Profile this query and note if an index is used. Also note the number of db hits and elapsed time.
...
The first and second executions will have the same number of db hits, but the difference will be the elapsed ms times.
The second execution of the query is purely execution time of the query.
--

Was your newly-created b-tree index used?
Are the number of db hits  or elapsed time reduced?
