...
Once you have completed the five steps of this Challenge, click the **Check Database** button and we will check the database for you.
...
.Solution
====
Here are the statements to drop the constraint and create the b-tree index:
