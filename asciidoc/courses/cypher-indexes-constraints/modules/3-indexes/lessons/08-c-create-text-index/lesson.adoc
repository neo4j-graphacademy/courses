...
Do you see that the b-tree index is used and the total db hits and elapsed time is lower?
...
Notice also that the total db hits are the same but the elapsed time is lower.
...
In this Challenge, you demonstrated that you can create a TEXT index in the graph to improve the performance of a query.
