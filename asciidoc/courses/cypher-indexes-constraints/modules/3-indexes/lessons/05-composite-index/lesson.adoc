...
[.video]
video::isNoaWM-L3c[youtube,width=560,height=315]

//https://youtu.be/isNoaWM-L3c
...
If you execute this query on the graph, you will see that it requires 18,552 total db hits to complete the query.
...
Repeat the above query with the `PROFILE`. You should see that with the index, only 7 total db hits occur.
