...
It should return 17 rows and have an elapsed time of ~15 ms in the Plan view.
...
This query executes about the same at ~15 ms in the Planner view.
...
Run this query multple times. It does not use any index, even the one defined or the RATED.rating property:
