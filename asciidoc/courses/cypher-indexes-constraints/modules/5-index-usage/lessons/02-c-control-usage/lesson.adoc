...
In this case you will see that the performance using either query is about the same.
...
In the next lesson, you will learn how to customize the implementation of your indexes.