...
:status: draft
:key-points: Graph Data Science, Graph projections, Algorithm categories, Execution modes, Algorithm configuration, Relationship aggregation, Projection modeling
