...
To create an aggregate version of it, we simply run the following modified version:
...
You now understand the concept of relationship aggregation and when to use it. You've seen how `count(r)` works in Cypher projections to collapse parallel relationships into single weighted relationships.

In the next lesson, you'll practice aggregating relationships hands-on, building projections that count relationships between actors, directors, and other entities.
