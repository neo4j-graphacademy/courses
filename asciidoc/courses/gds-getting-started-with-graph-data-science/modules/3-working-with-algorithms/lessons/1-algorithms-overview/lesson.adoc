...
NOTE: Notice here how the format of the syntax does not change the output. 
...
**Question it answers:** "Which nodes are central __and__ highly connected to other central central?"
...
Both Louvain and Leiden work by maximizing "modularity", or the density of connections within groups compared to teh density between groups.
