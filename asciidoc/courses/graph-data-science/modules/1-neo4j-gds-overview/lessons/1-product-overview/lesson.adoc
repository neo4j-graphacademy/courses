...
=== Installation
Of all the on-prem installations, Neo4j Desktop has the simplest process for GDS installation.  We will go over how to install GDS there first.  Overall, if you plan on testing GDS locally on your desktop, Neo4j is usually the easiest place to start.
