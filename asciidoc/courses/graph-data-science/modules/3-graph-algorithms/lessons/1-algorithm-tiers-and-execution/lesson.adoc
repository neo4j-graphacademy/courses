...
In this module, you will learn about the different algorithm tiers, the different execution modes for algorithms, and how to estimate the memory needed to run algorithms in GDS.
...
* *Production-quality:* Indicates that the algorithm has been tested with regards to stability and scalability. Algorithms in this tier are prefixed with `gds.<algorithm>`.
...
For more detail and best practices on execution modes, please refer to our https://neo4j.com/docs/graph-data-science/current/common-usage/running-algos/:[documentation].
...
More detailed information on usage and best practices with memory estimation can be found in our https://neo4j.com/docs/graph-data-science/current/common-usage/memory-estimation/:[documentation].
...
In this lesson you learned about the general characteristics of GDS algorithms.  In upcoming lessons you will go through the different algorithm types in more detail to understand what the different GDS algorithms can do and how you can apply them to different use cases.