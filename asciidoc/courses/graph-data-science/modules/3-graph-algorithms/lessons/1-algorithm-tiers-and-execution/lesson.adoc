...
In this lesson you learned about the general characteristics of GDS algorithms.  In upcoming lessons you will go through the different algorithm categories in more detail to understand what the different GDS algorithms can do and how you can apply them to different use cases.