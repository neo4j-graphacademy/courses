...
. *Property Filtering:* Using node and/or relationship property conditions to filter the graph, not just node label and relationship types.
...
. *Filtering with Relationship Property Conditions:* Add a label to source and target nodes for each relationship that meets the property condition
