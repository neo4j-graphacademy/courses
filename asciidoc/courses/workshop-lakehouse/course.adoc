...
* **Connections (Paths)** - how the warehouse data joins and connects
...
We recommend completing the link:/courses/neo4j-fundamentals/[Neo4j Fundamentals^] course if you are interested in those details.
