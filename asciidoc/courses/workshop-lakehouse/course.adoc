...
For the hands-on path you will need a coding agent such as Claude Code, Cursor, Codex, or Gemini CLI, together with the workshop Codespace - which provides read-only access to the BigQuery dataset and your Neo4j sandbox. The embedded sandbox window lets you inspect and query the graph by hand as you go.
