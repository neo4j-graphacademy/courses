...
Start the mock dealer-management API in a second terminal - your agent acts through it in Module 6:
...
* **Parts API running** - the mock dealer-management API your agent acts through in Module 6
