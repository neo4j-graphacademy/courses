...
| **The federated finale** | The SQL dialect your agent writes; the join paths still come from the connections graph
|===
...
* **Connections** → `join_paths`: grounded SQL routing where Text2SQL guesses
