...
The link:https://data-importer.neo4j.io/connection/connect[Neo4j Data Importer^] is a UI-based data importing tool. The data importer is ideal to get started quickly with testing and prototyping. However, there are limited options for data transformation, and it is unsuitable for large data sets.
