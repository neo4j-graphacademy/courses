...
There are Cypher functions to cast data to appropriate types. For example, when creating the `Person` nodes, you used the `toInteger()` function to cast IDs to integers (`Long`).
