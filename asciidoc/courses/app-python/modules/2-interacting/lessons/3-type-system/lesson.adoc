...
----
include::{repository-raw}/main/example/results.py[tag=integers]
----
...
[source,python,role=ncopy,subs="attributes+",indent=0]
----
include::{repository-raw}/main/example/results.py[tag=get]
----
...
----
include::{repository-raw}/main/src/utils.py[tag=toNativeTypes]
----
====
