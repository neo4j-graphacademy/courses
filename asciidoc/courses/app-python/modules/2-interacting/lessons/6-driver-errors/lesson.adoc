...
----
include::{repository-raw}/main/example/catch-errors.py[tag=catch]
----
...
[source,python,subs="attributes+",indent=0]
----
include::{repository-raw}/main/example/catch-errors.py[tag=promise]
----
...
// ----
// include::{repository-raw}/main/src/services/auth.service.py[tag=constraintError]
// ----
...
// [source,python,indent=0]
// ----
// include::{repository-raw}/{branch}/src/services/auth.service.py[tag="catch"]
// ----
