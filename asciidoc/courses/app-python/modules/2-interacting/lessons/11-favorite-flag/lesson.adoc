...
Your next challenge is to modify the link:{repository-raw}/main/src/services/movie.service.py[`MovieService`] to dynamically determine whether a movie is on the current user's My Favorite List.
...
----
include::{repository-raw}/main/src/services/movie.service.py[tag="getUserFavorites"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.py[tag="allcypher"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{previous-branch}/src/services/movie.service.py[tag="allcypher"]
----
