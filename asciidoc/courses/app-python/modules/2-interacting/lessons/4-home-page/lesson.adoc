...
You will modify the `all()` method of the link:{repository-blob}main/src/routes/movie.services.py[`MovieService`^] to do the following:
...
You can find the route handler, the function that handles the request, in link:{repository-blob}main/src/routes/movies.routes.py[`src/routes/movies.routes.js`^]:

.src/routes/movies.routes.js
[source,python,role=nocopy]
----
include::{repository-raw}/main/src/routes/movies.routes.py[tag=list]
----
...
The magic happens in the `MovieService`, located at link:{repository-blob}main/src/services/movies.service.py[`src/services/movies.service.js`^].
...
----
include::{repository-raw}/main/src/services/movie.service.py[tag=all]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.py[tag=allmovies]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.py[tag=return]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.py[tag=all]
----
====
