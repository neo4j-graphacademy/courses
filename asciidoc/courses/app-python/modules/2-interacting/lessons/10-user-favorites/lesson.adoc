...
1. The server directs the request to the route handler in link:{repository-blob}/main/src/routes/account.routes.py[`src/routes/account.routes.js`^], which verifies the user's JWT token before handling the request
2. The route handler creates an instance of the link:{repository-blob}/main/src/services/favorites.service.py[`FavoriteService`^].
...
----
include::{repository-raw}/main/example/index.py[tag=session]
----
...
[source,cypher]
----
include::{repository-raw}/main/cypher/2-interacting/9-user-favorites/creating-the-relationship.cypher[]
----
====
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.py[tag="create"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.py[tag="throw"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.py[tag="return",indent=0]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.py[tag=add]
...
[source,python]
----
include::{repository-raw}/{branch}/src/services/favorite.service.py[tag=remove]
----
====
...
[source,python]
----
include::{repository-raw}/{branch}/src/services/favorite.service.py[tag=all]
----
