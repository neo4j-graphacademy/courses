...
In this challenge, you will rewrite the `register()` method in the link:{repository-blob}main/src/routes/auth.services.py[`AuthService`^] to do the following:
...
----
include::{repository-raw}/main/src/services/auth.service.py[tag="register"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.py[tag="create"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.py[tag="extract"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.py[tag="return"]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.py[tag="register"]
----
====
