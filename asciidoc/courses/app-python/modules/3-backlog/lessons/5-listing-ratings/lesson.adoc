...
The list of ratings is populated by the `forMovie()` method in the link:{repository-blob}/src/modules/rating.service.py[`RatingService`^], which currently returns a hardcoded list of ratings.

.src/services/rating.service.js
[source,python,indent=0]
----
include::{repository-raw}/main/src/services/rating.service.py[tag=forMovie]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/rating.service.py[tag=forMovie]
----
