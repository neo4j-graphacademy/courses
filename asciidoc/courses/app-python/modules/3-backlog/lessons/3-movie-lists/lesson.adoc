...
In this challenge, you will implement the remaining methods in the link:{repository-blob}/main/api/dao/movies.py[`MovieService`^] for retrieving a list of movies:
