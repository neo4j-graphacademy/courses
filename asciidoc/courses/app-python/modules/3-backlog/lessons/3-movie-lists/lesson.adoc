...
In this challenge, you will implement the remaining methods in the link:{repository-blob}/main/src/services/movie.service.py[`MovieService`^] for retrieving a list of movies:
...
// ----
// include::{repository-raw}/10-genre-details/src/services/movie.service.py[tag=all]
// ----
...
[source,python,indent=0]
----
include::{repository-raw}/main/src/services/movie.service.py[tag=getByGenre]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.py[tag=getByGenre]
----
...
[source,python,indent=0]
----
include::{repository-raw}/main/src/services/movie.service.py[tag=getForActor]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.py[tag=getForActor]
----
...
[source,python,indent=0]
----
include::{repository-raw}/main/src/services/movie.service.py[tag=getForDirector]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.py[tag=getForDirector]
----
