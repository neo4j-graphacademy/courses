...
This list is populated by the API route at http://localhost:5000/api/genres, with the list being produced by the `all()` method within the link:{repository-blob}/main/src/services/genre.service.py[`GenreService`^].

.src/services/genre.service.js
[source,python,indent=0]
----
include::{repository-raw}/main/src/services/genre.service.py[tag=all]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/genre.service.py[tag=all]
----
