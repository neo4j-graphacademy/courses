...
The list is populated by the `all()` method in the link:{repository-blob}main/src/services/people.service.py[`PeopleService`^].

.src/services/people.service.js
[source,python,indent=0]
----
include::{repository-raw}/main/src/services/people.service.py[tag=all]
----
...
[source,python,indent=0]
----
include::{repository-raw}/{branch}/src/services/people.service.py[tag=all]
----
