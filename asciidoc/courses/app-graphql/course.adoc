...
This course covers building GraphQL APIs using the https://neo4j.com/docs/graphql/current/[Neo4j GraphQL Library.^]
...
Some familiarity with Neo4j is helpful, such as first completing the https://graphacademy.neo4j.com/training-overview-40/enrollment/["Overview Of Neo4j 4.x"] course, however not strictly required.
