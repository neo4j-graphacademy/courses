...
To create effective learning experiences, it is important to understand how courses are structured and configured.

In this lesson, you will learn about the course structure, required attributes, and how to define learning objectives.
