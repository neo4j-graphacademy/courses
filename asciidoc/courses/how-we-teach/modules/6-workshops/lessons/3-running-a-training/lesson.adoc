...
. `usecase` is the use case of the workshop, e.g. `fraudmovies`
. `participant-count` is the number of participants in the workshop
. `start-date in UTC` is the start date of the workshop in UTC
. `end-date in UTC` is the end date of the workshop in UTC
