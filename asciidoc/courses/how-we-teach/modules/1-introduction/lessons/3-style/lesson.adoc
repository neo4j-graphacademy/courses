...
To apply GraphAcademy's pedagogical principles effectively, you need to understand how to write content that engages learners while maintaining a professional, accessible tone.

In this lesson, you will learn about the Neo4j editorial style and specific GraphAcademy writing guidelines.
...
* *Avoid redundancy*
+
Don't use "Now", "So", and "Let's" at the start of sentences. These words can be redundant and do not add value to the content.
