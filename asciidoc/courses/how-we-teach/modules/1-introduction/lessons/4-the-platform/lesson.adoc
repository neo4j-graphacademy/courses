...
To create content that follows GraphAcademy's style guidelines, you need to understand where the code and content are stored and how the platform is organized.

In this lesson, you will learn about the GraphAcademy platform structure, key repositories, and the course folder organization.
...
In the next lesson, you will learn how learners and facilitators create and manage **Teams** on the GraphAcademy website.

In the lesson after that, you will learn about Asciidoc, and explore some code snippets.
