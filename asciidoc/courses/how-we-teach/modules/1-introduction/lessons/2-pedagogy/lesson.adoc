...
We use a pedagogical approach to teaching that is based on the principles of learning and teaching.

In this lesson, you will learn about GraphAcademy's pedagogical approach, including iterative learning cycles, core teaching principles, and the PRIMM framework.


== Iterative learning

GraphAcademy aims to provide an iterative learning experience of _learn, recognize, recall_.
...
You do not have to use these all the time, but they are good tools which help.
