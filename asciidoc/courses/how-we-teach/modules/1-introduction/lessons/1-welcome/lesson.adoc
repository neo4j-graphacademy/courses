...
Welcome to GraphAcademy's internal course on how we create effective learning experiences.

In this lesson, you will learn about GraphAcademy's mission, success metrics, and the foundational approach we take to teaching.
...
GraphAcademy achieves this with a **hands-on** learning approach with interactive exercises.
...
1. **Total enrollment** - An increasing number of enrollments means GraphAcademy offers courses that users care about. The goal is to increase total enrollment numbers by 30% year-on-year.

2. **Completed enrollment percentage** - Total enrollments is a vanity metric that will only go up. The more engaging our courses are, the more likely users are to complete them. The aim should be to have a 40% completion rate per course, way above industry standards for free online courses.
