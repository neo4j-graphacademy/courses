...
In the next lesson, you will learn how to run GraphAcademy **locally with Docker**, reset **`.neo4j`**, and resync when a new course shows **404**.

In the lesson after that, you will learn how to run **automated tests** locally to validate your course structure.
