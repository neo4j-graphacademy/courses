...
image::/../../../2-knowledge-graph-pipeline/lessons/2-create-a-graph/images/kg-builder-default-model.svg[Graph data model showing Document, Chunk, and Entity nodes with relationships between them]
