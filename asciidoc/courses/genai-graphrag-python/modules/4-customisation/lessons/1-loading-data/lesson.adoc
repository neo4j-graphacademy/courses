...
[source,python]
----
include::{repository-raw}/{branch}/genai-graphrag-python/examples/data_loader_custom_pdf.py[tag=pdf_file]
...
[source, python]
----
include::{repository-raw}/{branch}/genai-graphrag-python/examples/data_loader_custom_pdf.py[tags=**;!run_loader]
----
====
...
[source,python]
----
include::{repository-raw}/{branch}/genai-graphrag-python/examples/data_loader_text_file.py[tag=pdf_file]
...
[source, python]
----
include::{repository-raw}/{branch}/genai-graphrag-python/examples/data_loader_text_file.py[tags=**;!run_loader]
----
====
