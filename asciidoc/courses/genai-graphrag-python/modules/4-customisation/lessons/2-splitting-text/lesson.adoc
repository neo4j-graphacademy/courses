...
You can use the link:https://python.langchain.com/api_reference/text_splitters/character/langchain_text_splitters.character.CharacterTextSplitter.html[LangChain `CharacterTextSplitter`^] to split text into paragraphs.
