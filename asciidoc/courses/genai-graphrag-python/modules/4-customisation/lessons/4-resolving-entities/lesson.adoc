...
* The link:https://neo4j.com/docs/neo4j-graphrag-python/current/api.html#spacysemanticmatchresolver[`SpacySemanticMatchResolver`^] uses the link:https://spacy.io/[`spaCy`^] library to find and resolve entities with the same label and similar set of textual properties.
