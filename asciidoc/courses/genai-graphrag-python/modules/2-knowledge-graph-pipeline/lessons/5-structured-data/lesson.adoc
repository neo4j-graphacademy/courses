...
The knowledge graph graph you created is based on unstructured data extracted from documents. You may have access to structured data sources such as databases, CSV files, or APIs that contain valuable information relevant to your domain. Combining the structure and unstructured data can enhance the knowledge graph's richness and usefulness.
...
----
include::{repository-raw}/{branch}/genai-integration-langchain/kg_structured_builder.py[]
----
...
.Load docs.csv
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_structured_builder.py[tag=load_csv]
----
...
.PDF path
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_structured_builder.py[tag=pdf_path]
----
...
.Cypher statement
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_structured_builder.py[tag=cypher]
----
+
