...
You will create Lesson nodes from the structured data and connected them to the Document nodes using a `PDF_OF` relationship:
...
The resulting knowledge graph will now contain `Lesson` nodes connected to the `Document` nodes.
