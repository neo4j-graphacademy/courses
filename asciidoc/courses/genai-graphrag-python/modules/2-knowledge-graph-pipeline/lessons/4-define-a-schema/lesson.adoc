...
----
include::{repository-raw}/{branch}/genai-integration-langchain/kg_builder_schema.py[]
----
...
.NODES
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_builder_schema.py[tag=simple_nodes]
----
...
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_builder_schema.py[tag=node_types]
----
...
.RELATIONSHIP_TYPES
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_builder_schema.py[tag=relationship_types]
----
...
.PATTERNS
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_builder_schema.py[tag=patterns]
----
...
.schema
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_builder_schema.py[tag=kg_builder]
----
...
.All PDFs
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_builder_schema.py[tag=all_documents]
----
