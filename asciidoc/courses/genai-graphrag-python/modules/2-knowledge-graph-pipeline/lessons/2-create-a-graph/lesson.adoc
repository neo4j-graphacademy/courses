...
You are going to create a knowledge graph from the text within the link:https://graphacademy.neo4j.com/courses/genai-fundamentals/[Neo4j & Generative AI Fundamentals^] course.

image::images/doc-to-graph.png[diagram showing the SimpleKHPipeline process from document to graph]
...
The PDF document contains the content from the link:https://graphacademy.neo4j.com/courses/genai-fundamentals/1-generative-ai/1-what-is-genai/[What is Generative AI?^] lesson.
...
----
+
Model parameters, `model_params`, are set to reduce the `reasoning_effort` to improve response times.
