...
.Neo4j connection
----
include::{repository-raw}/{branch}/genai-graphrag-python/kg_builder.py[tag=neo4_driver]
----
...
.LLM
----
include::{repository-raw}/{branch}/genai-graphrag-python/kg_builder.py[tag=llm]
----
...
.Embedding model
----
include::{repository-raw}/{branch}/genai-graphrag-python/kg_builder.py[tag=embedder]
----
...
.kg_builder
----
include::{repository-raw}/{branch}/genai-graphrag-python/kg_builder.py[tag=kg_builder]
----
...
.kg_builder
----
include::{repository-raw}/{branch}/genai-graphrag-python/kg_builder.py[tag=run_one_doc]
----
