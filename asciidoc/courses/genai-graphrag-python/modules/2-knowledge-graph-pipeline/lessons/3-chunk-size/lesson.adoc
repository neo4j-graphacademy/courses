...
include::{repository-raw}/{branch}/genai-graphrag-python/solutions/kg_builder_split.py[tag=text_splitter]
----
+
[NOTE]
...
[source, python]
----
include::{repository-raw}/{branch}/genai-graphrag-python/solutions/kg_builder_split.py[tag=**]
----
====
