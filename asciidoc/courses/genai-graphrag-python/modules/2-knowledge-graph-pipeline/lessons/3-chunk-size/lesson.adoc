...
[source, python]
----
include::{repository-raw}/{branch}/genai-integration-langchain/kg_builder_split.py[tag=import_text_splitter]

include::{repository-raw}/{branch}/genai-integration-langchain/kg_builder_split.py[tag=text_splitter]
----
+
[NOTE]
...
[source, python]
----
include::{repository-raw}/{branch}/genai-integration-langchain/solutions/kg_builder_split.py[tag=kg_builder]
----
...
[source, python]
----
include::{repository-raw}/{branch}/genai-integration-langchain/kg_builder_split.py[tag=**]
----
====
