...
=====
If you can't create an Aura instance, you can add the Sandbox you have been using during the course as a *Self-managed* instance in the link:https://console.neo4j.io/graphacademy[Aura console^].
