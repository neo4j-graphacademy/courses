...
* A single property `released` is set - `SET m.released = datetime('2024-01-01')`
...
----
MERGE (m:Movie {title: "Movie title", released: date('2026-01-01')})
