...
. Run the import to create `Customer` nodes
...
. link:https://raw.githubusercontent.com/neo4j-graph-examples/northwind/refs/heads/main/import/northwind-customer.zip[Download the Northwind dataset^]
