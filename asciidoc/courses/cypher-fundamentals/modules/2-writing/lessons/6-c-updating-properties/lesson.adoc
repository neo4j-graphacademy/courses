...
We have already created the _Movie_ node for the movie _Get Out_, but we forgot to add the tagline which is _Gripping, scary, witty and timely!_ and the released year of 2017.
