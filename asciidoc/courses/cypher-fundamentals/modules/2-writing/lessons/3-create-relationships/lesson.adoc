...
If the _Person_ and _Movie_ nodes both already exist, we can find them using a `MATCH` clause before creating the relationship between them.
...
[.slide]
== Relationship Direction Defaults
