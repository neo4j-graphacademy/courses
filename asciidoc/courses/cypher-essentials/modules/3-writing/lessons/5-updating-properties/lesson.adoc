...
In the context of particular `MERGE`  or `MATCH` statement where you have defined a variable to reference the node or relationship, you can set property values.
