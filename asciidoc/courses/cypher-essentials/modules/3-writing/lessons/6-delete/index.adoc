...
Run this code to delete the node:
...
Run this Cypher code to find the node and remove its property:
...
Run this Cypher code to find the node add the _tagline_ back in the node:
...
Run this Cypher code to remove the _tagline_ property:
