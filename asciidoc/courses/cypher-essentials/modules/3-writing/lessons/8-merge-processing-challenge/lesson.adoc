...
** set the _revenue_ property for the node referenced by n  to  [copy]#n.revenue * 10#
* If the node does not exist:
** set the _year_ property to [copy]#2019#
** set the _revenue_ property to [copy]#1000#
