...
image::images/movie-schema.jpg[movie-schema-image,width=600,align=center]
...
The domain model shown above was visualized in Neo4j Browser using this Cypher code.
