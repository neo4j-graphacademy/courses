...
[TIP]
Open the Sandbox if it is not open (Toggle Sandbox). Wait a moment until you see *neo4j$* in the top query edit pane.
Click Copy to Clipboard, and paste the Cypher code to the query edit pane (top-most pane of the Sandbox). Then click the *Run* button in the top pane of the Sandbox.
