...
image::images/Whiteboard.svg[Whiteboard-image,width=600,align=center]
...
Click Copy to Clipboard, and paste the Cypher code in the query edit pane (top-most pane of the sandbox). Then click the *Run* button in the top pane of the Sandbox you see on the right.
