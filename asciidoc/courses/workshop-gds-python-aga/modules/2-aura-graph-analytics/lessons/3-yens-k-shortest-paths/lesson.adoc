...
image::images/yens_multiple_paths.svg[Comparison of Dijkstra's single path and Yen's multiple paths, showing benefits of multiple options.]
...
You now have the full GDS toolkit: Python workflows and scalable analytics with Aura Graph Analytics, built on top of the projection and algorithm foundations.
