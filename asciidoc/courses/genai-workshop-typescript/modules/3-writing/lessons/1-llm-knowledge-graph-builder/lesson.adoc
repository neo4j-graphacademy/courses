...
In this lesson, you used the LLM Knowledge Graph Builder to add data to your database. You can now use the data in your database to build a knowledge graph and answer questions about the data.
