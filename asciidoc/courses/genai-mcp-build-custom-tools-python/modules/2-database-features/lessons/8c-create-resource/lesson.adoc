...
[source,python]
----
include::{repository-raw}/main/solutions/8c-create-resource/main.py[tag=get_movie]
----
...
* [copy]#603# - The Matrix (1999)
* [copy]#13# - Forrest Gump (1994)
* [copy]#550# - Fight Club (1999)
* [copy]#680# - Pulp Fiction (1994)
...
You should the output structured in natural language:

.Resource template output
[source,output]
----
Constructed URI: movie://603


✨ Resource Contents:
------------------------------------------------------------
# Matrix, The (1999-03-31)
...
Structuring the content as text may mean more tokens for the LLM to process, but it also makes the information easier to understand and use.
