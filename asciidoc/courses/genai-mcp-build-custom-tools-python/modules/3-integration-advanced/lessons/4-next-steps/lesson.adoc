...
Continue your GraphAcademy journey:

* link:/courses/llm-fundamentals/[Introduction to Neo4j & LLMs^] - Learn how graphs enhance LLM applications
* link:/courses/neo4j-fundamentals/[Neo4j Fundamentals^] - Deepen your Cypher and graph modeling skills
* link:/courses/app-python/[Building Neo4j Applications with Python^] - Create full-stack applications
...
* link:https://neo4j.com/developer/cypher/[Cypher Query Language Reference^]
* link:https://community.neo4j.com[Neo4j Community Forum^]

**GraphRAG Resources**

* link:https://neo4j.com/labs/genai-ecosystem/[Neo4j GenAI Ecosystem^]
* link:https://neo4j.com/developer/kb/explanation-of-graphrag/[Understanding GraphRAG^]
