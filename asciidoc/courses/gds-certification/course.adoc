...
:categories: certification:2, advanced:11
:status: active
:certification: true
:questions: 40
:duration: 1 hour
...
:key-points: Comprehensive knowledge of the Neo4j Graph Data Science Library, Graph Data Science workflows
...
Take the Neo4j Graph Data Science Certification exam right now, and you’ll be done in 1 hour or less.
...
The exam includes 40 questions in 1 hour.
