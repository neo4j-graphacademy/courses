...
This query limits the query to retroieve five nodes.
...
With this simple query, m need not be redefined or scoped, but next you will learn how pipelining is really useful.
