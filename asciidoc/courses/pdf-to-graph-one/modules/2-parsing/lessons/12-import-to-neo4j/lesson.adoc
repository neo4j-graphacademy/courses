...
What it can't answer: **what they talked about**. The body text is still unstructured -- names, organizations, topics, and locations mentioned in the email content haven't been extracted. That's Course 2.
...
**Course 1 complete.** The next course extracts entities and topics from the email body text.
