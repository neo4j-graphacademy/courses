...
In the `solutions/tools/` folder, create a new file called `vector.py`.  Add the following line to import the `Neo4jVector`.
...
[source,python]
----
include::{repository-raw}/main/solutions/tools/vector.py[tags=importvector,importllm]
----
...
[source,python]
----
include::{repository-raw}/main/solutions/tools/vector.py[tags=importtool]
----
