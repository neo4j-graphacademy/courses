...
For example, you could ask "[copy]#Who acted in Toy Story?#".
...
====
    ...
    Action Input: {"name": "Toy Story", "type": "movie", "info": "cast"}
    ...
    > Finished chain.
    {'query': '{"name": "Toy Story", "type": "movie", "info": "cast"}', 'result': 'Jim Varney, Tim Allen, Tom Hanks, and Don Rickles are part of the cast of the movie "Toy Story".'}Do I need to use a tool? No
    Final Answer: Jim Varney, Tim Allen, Tom Hanks, and Don Rickles are part of the cast of the movie "Toy Story".
