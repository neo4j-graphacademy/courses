...
----
include::{repository-raw}/langchain0.1-chatbot/solutions/scoped.py[tag=importprompt]
----
...
----
include::{repository-raw}/langchain0.1-chatbot/solutions/scoped.py[tag=prompt]
----
...
----
include::{repository-raw}/langchain0.1-chatbot/solutions/scoped.py[tag=agent]
----
