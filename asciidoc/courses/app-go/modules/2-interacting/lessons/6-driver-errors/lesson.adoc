...
[source,go,indent=0]
----
include::{repository-raw}/working/pkg/challenges/error_test.go[tag="handle"]
----

1. The `.Code` property provides a uniquen <<Error Code>>
...
include::./questions/1-cast.adoc[leveloffset=+1]

include::./questions/2-error-title.adoc[leveloffset=+1]
