...
In the Neo4j Go Driver, an error extending the link:https://neo4j.com/docs/api/Go-driver/current/api.html#neo4j.exceptions.Neo4jError[`neo4j.exceptions.Neo4jError`^] class will be thrown.
