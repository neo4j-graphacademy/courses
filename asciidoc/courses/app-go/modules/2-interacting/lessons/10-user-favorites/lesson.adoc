...
2. The route handler creates an instance of the link:{repository-blob}/main/api/services/favorites.go[`FavoriteService`^].
...
Define a new transaction function to execute the Cypher query below to create the `:HAS_FAVORITE` relationship between the User and the Movie.
...
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag=add_to_favorites_run]
----
...
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag="throw"]
----
...
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag="return"]
----
...
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag="call_add_to_favorites"]
----
...
.api/services/favorites.go
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag=add]
...
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag=remove]
----
====
...
[source,go,indent=0]
----
include::{repository-raw}/main/api/services/favorites.go[tag=all]
----
...
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag=lambda]
----

[NOTE]
.Escaped Braces
====
You may have noticed that the code block above features double curly braces (`{{` and `}}`) within the `MATCH` clause rather than the single braces used within the Cypher query.
...
[source,go,indent=0]
----
include::{repository-raw}/{branch}/api/services/favorites.go[tag=all]
----
====
