...
[source,go,indent=0]
----
include::{repository-raw}/working/example/main.go[tag="getActors"]
----
...
[source,go]
----
include::{repository-raw}/working/example/main.go[tag="Next"]
----
...
[source,go]
----
include::{repository-raw}/working/example/main.go[tag="NextRecord"]
----
...
[source,go]
----
include::{repository-raw}/working/example/main.go[tag="Single"]
----
...
[source,go]
----
include::{repository-raw}/working/example/main.go[tag="Collect"]
----
...
[source,go]
----
include::{repository-raw}/working/example/main.go[tag="Consume"]
----
...
[source,go,indent=0]
----
include::{repository-raw}/working/example/main.go[tag="keys"]
----
...
[source,go]
----
include::{repository-raw}/working/example/main.go[tags="index,alias",indent=0]
----
