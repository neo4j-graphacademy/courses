...
----
include::{repository-raw}/working/example/results.go[tag=run]
----
// TODO: main
...
----
include::{repository-raw}/working/example/results.go[tags="nextrecord,alias",indent=0]
----
...
include::{repository-raw}/working/example/results.go[tag=keys,indent=0]

include::{repository-raw}/working/example/results.go[tags="nextrecord,index",indent=0]
----
...
.Casting Values
----
include::{repository-raw}/working/example/results.go[tag=cast]
----
...
----
include::{repository-raw}/working/example/results.go[tag=node]
----
...
[source,go,role=ncopy,subs="attributes+",indent=0]
----
include::{repository-raw}/working/example/results.go[tag=path]
----
...
[source,go,indent=0]
----
include::{repository-raw}/working/example/results.go[tag=time]
----
...
----
include::{repository-raw}/working/example/results.go[tag=duration]
----
...
----
include::{repository-raw}/working/example/results.go[tag=point2d]
----
