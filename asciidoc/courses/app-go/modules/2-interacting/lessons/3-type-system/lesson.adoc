...
----
include::{repository-raw}/15-person-profile/example/results.go[tag=run]
----
// TODO: main
...
As mentioned in the previous lesson, you can use the alias as defined in the `RETURN` portion of the Cypher query:

[source,go]
.Accessing a value by Alias
----
include::{repository-raw}/15-person-profile/example/results.go[tags="nextrecord,alias",indent=0]
----
...
include::{repository-raw}/15-person-profile/example/results.go[tag=keys,indent=0]

include::{repository-raw}/15-person-profile/example/results.go[tags="nextrecord,index",indent=0]
----
...
.Casting Values
----
include::{repository-raw}/15-person-profile/example/results.go[tag=cast]
----
...
----
include::{repository-raw}/15-person-profile/example/results.go[tag=node]
----
...
[source,go,role=ncopy,subs="attributes+",indent=0]
----
include::{repository-raw}/15-person-profile/example/results.go[tag=path]
----
...
[source,go,indent=0]
----
include::{repository-raw}/15-person-profile/example/results.go[tag=time]
----
...
----
include::{repository-raw}/15-person-profile/example/results.go[tag=duration]
----
...
----
include::{repository-raw}/15-person-profile/example/results.go[tag=point2d]
----
...
In this lesson you have learned how to handle data returned by a Cypher query.
