...
----
include::{repository-raw}/15-person-profile/example/main.go[tag="session",indent=0]
...
[source,go,role=nocopy,subs="attributes+"]
----
include::{repository-raw}/15-person-profile/example/main.go[tag=sessionWithArgs,indent=0]
...
----
include::{repository-raw}/15-person-profile/example/main.go[tag=session.run]
...
[source,go,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/15-person-profile/example/main.go[tag=session.readTransaction]
...
[source,go,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/15-person-profile/example/main.go[tag=session.writeTransaction,indent=0]
...
[source,go,role=nocopy,subs="attributes+"]
----
include::{repository-raw}/15-person-profile/example/main.go[tag=session.beginTransaction,indent=0]
...
[source,go,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/15-person-profile/example/main.go[tag=session.beginTransaction.Try]
...
[source,go,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/15-person-profile/example/main.go[tag=session.close]
...
[source,go,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/15-person-profile/example/main.go[tag=createPerson]
