...
2. A boolean to represent whether the returned value is included in the record or not (this is to disambiguate returned default values such as `0` or empty strings for instance)
