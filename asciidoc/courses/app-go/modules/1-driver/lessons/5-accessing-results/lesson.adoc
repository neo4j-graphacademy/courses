...
[source,go]
----
include::{repository-raw}/main/example/example.go[tag="Next"]
----
...
[source,go]
----
include::{repository-raw}/main/example/example.go[tag="NextRecord"]
----
...
[source,go]
----
include::{repository-raw}/main/example/example.go[tag="Single"]
----
...
[source,go]
----
include::{repository-raw}/main/example/example.go[tag="Collect"]
----
...
[source,go]
----
include::{repository-raw}/main/example/example.go[tag="Consume"]
----
...
[source,go,indent=0]
----
include::{repository-raw}/main/example/example.go[tag="keys"]
----
...
[source,go]
----
include::{repository-raw}/main/example/example.go[tags="index,alias",indent=0]
----
