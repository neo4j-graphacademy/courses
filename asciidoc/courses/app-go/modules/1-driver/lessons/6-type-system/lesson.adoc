...
----
include::{repository-raw}/main/pkg/example/results.go[tag=run]
----
...
----
include::{repository-raw}/main/pkg/example/results.go[tags="nextrecord,alias",indent=0]
----
...
include::{repository-raw}/main/pkg/example/results.go[tag=keys,indent=0]

include::{repository-raw}/main/pkg/example/results.go[tags="nextrecord,index",indent=0]
----
...
.Casting Values
----
include::{repository-raw}/main/pkg/example/results.go[tag=cast]
----
...
This definition has been taken from the link:https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v5@v5.4.0/neo4j/dbtype#Node[source code for the Neo4j Go Driver^]
====
...
----
include::{repository-raw}/main/pkg/example/results.go[tag=node]
----
...
----
This definition has been taken from the link:https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v5@v5.4.0/neo4j/dbtype#Relationship[source code for the Neo4j Go Driver^]
...
This definition has been taken from the link:https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v5@v5.4.0/neo4j/dbtype#Path[source code for the Neo4j Go Driver^]
...
[source,go,role=ncopy,subs="attributes+",indent=0]
----
include::{repository-raw}/main/pkg/example/results.go[tag=path]
----
...
[source,go,indent=0]
----
include::{repository-raw}/main/pkg/example/results.go[tag=time]
----
...
----
include::{repository-raw}/main/pkg/example/results.go[tag=duration]
----
...
----
include::{repository-raw}/main/pkg/example/results.go[tag=point2d]
----
...
In the next lesson you will learn how to add type safety to your Go project.