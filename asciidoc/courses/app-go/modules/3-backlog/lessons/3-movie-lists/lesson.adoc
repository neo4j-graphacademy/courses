...
[source,go,indent=0]
----
include::{repository-raw}/working/pkg/services/movies.go[tag=getByGenre]
...
[source,go,indent=0]
----
include::{repository-raw}/working/pkg/services/movies.go[tag=getForActor]
...
[source,go,indent=0]
----
include::{repository-raw}/working/pkg/services/movies.go[tag=getForDirector]
