...
The list of ratings is populated by the `for_movie()` method in the link:{repository-blob}/api/dao/ratings.py[`RatingDAO`^], which currently returns a hardcoded list of ratings.
