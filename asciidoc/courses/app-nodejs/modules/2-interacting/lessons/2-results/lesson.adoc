...
The drawback to the Promise API method of consuming results, is that the Promise will only resolve once all results have been received by the Driver.
...
You could use this method with websockets, or a similar technology to update the front-end application with new results as they are made available.
