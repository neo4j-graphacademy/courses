...
[%collapsible]
.Click here to reveal the entire method:
====
...
You can view the test file by opening `test/challenges/05-authenticating.spec.js`.
...
In this module, we have learned how to use sessions and transactions to read data from, and write data to Neo4j.
