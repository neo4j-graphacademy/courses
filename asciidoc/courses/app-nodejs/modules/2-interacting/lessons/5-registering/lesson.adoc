...
In this challenge, you will need to rewrite the `register` method in the link:{repository-blob}main/src/routes/auth.services.js[`AuthService`^] to do the following:
