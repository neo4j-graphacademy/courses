...
----
include::https://raw.githubusercontent.com/{repository}/main/example/index.js[tag=import]

include::https://raw.githubusercontent.com/{repository}/main/example/index.js[tag=driver,indent=0]
----
...
[source,js,indent=0,subs="attributes+"]
----
include::https://raw.githubusercontent.com/{repository}/main/example/index.js[tag=verifyConnectivity,indent=0]
----
