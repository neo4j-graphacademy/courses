...
To connect to and query Neo4j from within a Node.js application, you can use  the link:https://neo4j.com/developer/javascript[Neo4j JavaScript Driver^].
...
In this lesson, we learned about the Neo4j JavaScript Driver and how it can be used to connect to Neo4j from within a Node.js application.
