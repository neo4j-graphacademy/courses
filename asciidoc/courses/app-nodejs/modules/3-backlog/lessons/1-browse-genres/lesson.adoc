...
In this lesson, you updated the `GenreService` to retrieve a list of genres from the database.

In the next lesson, you will update the `GenreService` to query Neo4j to find the details of an individual genre.
