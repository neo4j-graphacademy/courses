...
This list is populated by the API route at http://localhost:3000/api/movies, with the list being produced by the `all()` method within the link:{repository-blob}/main/src/services/genre.service.js[`GenreService`^].
