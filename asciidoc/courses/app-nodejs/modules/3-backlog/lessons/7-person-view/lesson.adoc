...
You will need to update this method to run the following cypher statement in a **read transaction**.
...
* The returned object should include counts of the number of films that the person has acted in or directed
...
* Modify the `getSimilarMovies()` method to query Neo4j and return a list of similar people
