...
One of the challenges of RAG is understanding what the user is asking for and find the correct information to pass to the LLM.
...
An embedding model is used to create a vector representation of all the source data.
