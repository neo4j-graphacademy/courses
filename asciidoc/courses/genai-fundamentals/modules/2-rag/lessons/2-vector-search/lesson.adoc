...
When referring to vectors in the context of machine learning and NLP, the term "embedding" is typically used. Embeddings are numerical translations of data objectsm, for example images, text, or audio, represented as vectors.
