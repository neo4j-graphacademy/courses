...
Recreate the knowledge graph with the defined nodes by:

. Deleting any existing nodes and relationships.
+
[source, cypher]
...
[source, python]
----
include::{repository-raw}/{branch}/workshop-genai2/solutions/kg_builder_schema.py[tags=**;!simple_nodes;!all_documents]
----
====
...
Recreate the knowledge graph by:
...
.All PDFs
----
include::{repository-raw}/{branch}/workshop-genai2/solutions/kg_builder_schema.py[tag=all_documents]
----
====
