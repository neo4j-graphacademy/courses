...
:type: lesson
:branch: new-workshop
:repository-dir-name: workshop-genai2
...
You can test your setup by running `{repository-dir-name}/test_environment.py` - this will attempt to connect to the Neo4j sandbox and the OpenAI API.
