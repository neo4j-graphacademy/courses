...
You will enhance your agent by adding a search lesson retrieval tool that combines semantic search and vectors with graph traversal using cypher.
...
**Lesson Retrieval Tool:**

- Finding content within lessons 
