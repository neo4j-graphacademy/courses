...
In this challenge, you will modify the `add()` method in the link:{repository-blob}main/src/routes/review.services.js[`ReviewService`^] to save ratings into Neo4j.
...
----
include::{repository-raw}/main/src/services/rating.service.java[tag=add]
----
...
include::{repository-raw}/{branch}/src/services/rating.service.java[tag=convert,indent=0]
----
...
[source,java]
----
include::{repository-raw}/{branch}/src/services/rating.service.java[tag=write,indent=0]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/rating.service.java[tag=throw,indent=0]
----
...
Use the `toNativeTypes()` function to convert any non-native types into their Java equivalent.

[source,java]
----
include::{repository-raw}/{branch}/src/services/rating.service.java[tag=addreturn,indent=0]
----

[TIP]
This example uses the link:https://developer.mozilla.org/en-US/docs/Web/Java/Reference/Operators/Destructuring_assignment[Destructuring assignment^] technique to get the first record from the `res.records` array.
...
You have also explicitly converted a Java integer into a Neo4j Integer using the `int()` function.
