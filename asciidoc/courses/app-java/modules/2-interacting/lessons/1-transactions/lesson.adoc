...
----
include::{repository-raw}/main/example/index.java[tag="driver.session",indent=0]
----
...
[source,java,role=nocopy,subs="attributes+"]
----
include::{repository-raw}/main/example/index.java[tag="session",indent=0]
----
...
[source,java,role=nocopy,subs="attributes+"]
----
include::{repository-raw}/main/example/index.java[tag=sessionWithArgs,indent=0]
----
...
----
include::{repository-raw}/main/example/index.java[tag=session.run]
----
...
[source,java,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/main/example/index.java[tag=session.readTransaction]
----
...
[source,java,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/main/example/index.java[tag=session.writeTransaction,indent=0]
----
...
[source,java,role=nocopy,subs="attributes+"]
----
include::{repository-raw}/main/example/index.java[tag=session.beginTransaction,indent=0]
----
...
[source,java,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/main/example/index.java[tag=session.beginTransaction.Try]
----
...
[source,java,role=nocopy,subs="attributes+",indent=0]
----
include::{repository-raw}/main/example/index.java[tag=createPerson]
----
====
