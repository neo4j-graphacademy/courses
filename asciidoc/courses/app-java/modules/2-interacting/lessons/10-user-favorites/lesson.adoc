...
[source,cypher]
----
include::{cypher-repository-raw}/2-interacting/9-user-favorites/creating-the-relationship.cypher[]
----
====
...
----
include::{cypher-repository-raw}/2-interacting/9-user-favorites/deleting-the-relationship.cypher[]
----
...
[source,cypher]
----
include::{cypher-repository-raw}/2-interacting/9-user-favorites/listing-favorites.cypher[]
----
====
