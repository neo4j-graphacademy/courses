...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.java[tag="create"]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.java[tag="throw"]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.java[tag="return",indent=0]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/favorite.service.java[tag=add]
...
[source,java]
----
include::{repository-raw}/{branch}/src/services/favorite.service.java[tag=remove]
----
====
...
[source,java]
----
include::{repository-raw}/{branch}/src/services/favorite.service.java[tag=all]
----
