...
You will modify the `all()` method of the link:{repository-blob}main/src/routes/movie.services.js[`MovieService`^] to do the following:
...
----
include::{repository-raw}/main/src/routes/movies.routes.java[tag=list]
----
...
----
include::{repository-raw}/main/src/services/movie.service.java[tag=all]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.java[tag=allmovies]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.java[tag=return]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/movie.service.java[tag=all]
----
====
