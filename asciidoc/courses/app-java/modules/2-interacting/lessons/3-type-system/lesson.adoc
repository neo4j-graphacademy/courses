...
Some values like strings, numbers, booleans, and nulls have a direct mapping to Java types but more complex types like nodes, relationship, points, durations need special handling.
...
TODO: not true for Java, here we rather need to talk about the naming of Integer vs. Long/Integer and Float vs. Double/Float
...
----
include::{repository-raw}/main/src/main/java/example/results.java[tag=integers]
----
