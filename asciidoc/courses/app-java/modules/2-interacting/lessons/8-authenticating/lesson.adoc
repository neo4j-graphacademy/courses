...
1. A route handler `login` in link:{repository-blob}/main/src/main/java/neoflix/routes/AuthRoutes.java#L32[`src/main/java/neoflix/routes/AuthRoutes.java`^] listens for a `POST` request.
