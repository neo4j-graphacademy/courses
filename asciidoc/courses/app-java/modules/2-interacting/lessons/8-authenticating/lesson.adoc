...
In this challenge you will rewrite the `authenticate()` function of the link:{repository-blob}main/src/routes/auth.services.js[`AuthService`^] to do the following:
...
----
include::{repository-raw}/main/src/services/auth.service.java[tag=authenticate]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.java[tag="query"]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.java[tag="norecords"]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.java[tag="password"]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/auth.service.java[tag="authenticate"]
----
