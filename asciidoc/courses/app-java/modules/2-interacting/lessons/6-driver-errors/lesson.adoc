...
// [source,cypher]
// ----
// include::{repository-cypher-raw}/2-interacting/6-unique-emails/constraint.cypher[]
// ----
...
// [source,cypher]
// ----
// include::{repository-cypher-raw}/2-interacting/6-unique-emails/create-user.cypher[]
// ----
