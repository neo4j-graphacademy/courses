...
// [source,cypher]
// ----
// include::{cypher-repository-raw}/2-interacting/6-unique-emails/constraint.cypher[]
// ----
...
// [source,cypher]
// ----
// include::{cypher-repository-raw}/2-interacting/6-unique-emails/create-user.cypher[]
// ----
