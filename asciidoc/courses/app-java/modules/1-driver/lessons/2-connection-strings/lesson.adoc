...
----
include::{repository-raw}/main/example/index.java[tag=pseudo]
----
...
[source,role=nocopy]
----
include::{repository-raw}/main/example/index.java[tag=connection]
----
...
----
include::{repository-raw}/main/example/index.java[tag=auth]
----
...
----
include::{repository-raw}/main/example/index.java[tag=configuration]
----
