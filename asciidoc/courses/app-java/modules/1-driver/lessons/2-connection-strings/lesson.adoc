...
For more information or a full list of configuration options, please link:https://neo4j.com/docs/java-manual/current/get-started/[visit the Neo4j Java Driver manual^].
