= Listing People
:type: challenge
:test-filename: _14_PersonListTest
...
The list is populated by the `all()` method in the link:{repository-blob}/main/src/main/java/neoflix/services/PeopleService.java[`PeopleService`^].

.src/main/java/neoflix/services/PeopleService.java
[source,java,indent=0]
----
include::{repository-raw}/main/src/main/java/neoflix/services/PeopleService.java[tag=all]
----
...
[source,cypher]
----
include::{cypher-repository-raw}/3-backlog/6-person-list/find-people.cypher[]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/main/java/neoflix/services/PeopleService.java[tag=all]
----
