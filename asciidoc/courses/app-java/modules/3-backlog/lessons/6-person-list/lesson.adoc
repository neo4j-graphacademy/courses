...
----
include::{repository-raw}/main/src/services/people.service.java[tag=all]
----
 ...
 ** **Hint:** You can use a link:https://developer.mozilla.org/en-US/docs/Web/Java/Reference/Operators/Conditional_Operator[conditional operator^] within the string literal to add this `WHERE` clause.
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/people.service.java[tag=all]
----
