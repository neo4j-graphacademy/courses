...
:type: challenge
:test-filename: _10_GenreDetailsTest
...
.src/main/java/neoflix/services/GenreService.java
[source,java,indent=0]
----
include::{repository-raw}/main/src/main/java/neoflix/services/GenreService.java[tag=find]
----
...
[source,cypher]
----
include::{cypher-repository-raw}/3-backlog/2-find-genre-details/genre-details.cypher[]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/main/java/neoflix/services/GenreService.java[tag=find]
----
====
