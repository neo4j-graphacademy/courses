...
----
include::{repository-raw}/main/src/services/genre.service.java[tag=find]
----
...
* Remember to close the session and use the `toNativeTypes()` function to convert the genre value to native Java types.
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/genre.service.java[tag=find]
----
====
