...
----
include::{repository-cypher-raw}/3-backlog/7-person-view/person-profile.cypher[]
----
...
[source,cypher,indent=0]
----
include::{repository-cypher-raw}/3-backlog/7-person-view/similar-people.cypher[]
----
