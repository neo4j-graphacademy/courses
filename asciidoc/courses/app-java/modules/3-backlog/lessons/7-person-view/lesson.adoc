...
----
include::{repository-raw}/main/src/services/people.service.java[tag="findById"]
----
...
* Remember to close the session and use the `toNativeTypes()` function to convert the object into native Java types.
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/people.service.java[tag="findById"]
----
...
[source,java,indent=0]
----
include::{repository-raw}/main/src/services/people.service.java[tag="getSimilarPeople"]
----
...
* Remember to close the session and use the `toNativeTypes()` function within a `map()` function on `res.records` to convert the values to native Java types.
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/services/people.service.java[tag="getSimilarPeople"]
----
