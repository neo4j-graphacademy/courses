...
----
include::{cypher-repository-raw}/3-backlog/7-person-view/person-profile.cypher[]
----
...
[source,cypher,indent=0]
----
include::{cypher-repository-raw}/3-backlog/7-person-view/similar-people.cypher[]
----
