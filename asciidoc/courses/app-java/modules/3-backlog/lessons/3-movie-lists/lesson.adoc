...
:type: challenge
:test-filename: _11_MovieListTest
:branch: 11-movie-lists

In this challenge, you will implement the remaining methods in the link:{repository-blob}/main/src/main/java/neoflix/services/MovieService.java[`MovieService`^] for retrieving a list of movies:
...
.src/main/java/neoflix/services/MovieService.java - all() method
[source,java,indent=0]
----
include::{repository-raw}/10-genre-details/src/main/java/neoflix/services/MovieService.java[tag=all]
----
...
[source,java,indent=0]
----
include::{repository-raw}/main/src/main/java/neoflix/services/MovieService.java[tag=getByGenre]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/main/java/neoflix/services/MovieService.java[tag=getByGenre]
----
...
[source,java,indent=0]
----
include::{repository-raw}/main/src/main/java/neoflix/services/MovieService.java[tag=getForActor]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/main/java/neoflix/services/MovieService.java[tag=getForActor]
----
...
[source,java,indent=0]
----
include::{repository-raw}/main/src/main/java/neoflix/services/MovieService.java[tag=getForDirector]
----
...
[source,java,indent=0]
----
include::{repository-raw}/{branch}/src/main/java/neoflix/services/MovieService.java[tag=getForDirector]
----
