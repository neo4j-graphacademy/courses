...
Graph Data Science library offers a `gds.alpha.scaleProperties` procedure that helps us with feature normalization.
...
The `gds.alpha.scaleProperties` offers six different normalization methods:
