...
You will use Python and the Neo4j GraphRAG package to chunk up course content and create embeddings for each chunk. 
...
You will load the content and chunk it using Python and the Neo4j GraphRAG Python Library.
