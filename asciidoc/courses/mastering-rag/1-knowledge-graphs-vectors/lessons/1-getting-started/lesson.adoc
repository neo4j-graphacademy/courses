...
We have created a link:https://github.com/willtai/genai-workshop[repository^] for this workshop.
...
Clone the link:https://github.com/willtai/genai-workshop[github.com/willtai/genai-workshop] repository:

[source,bash]
----
git clone https://github.com/willtai/genai-workshop
----
