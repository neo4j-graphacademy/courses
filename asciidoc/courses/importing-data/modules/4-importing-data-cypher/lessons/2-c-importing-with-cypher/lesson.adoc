...
[IMPORTANT]
Although you can execute the Cypher code in this challenge, you can only verify your results of this Challenge if you have completed all previous Challenges.

This challenge has 6 steps:
...
[IMPORTANT]
Run `SHOW CONSTRAINTS` to confirm that you have constraints defined for the _Person_, _Movie_, _User_, and _Genre_ nodes as you must have the constraints defined for the import.

== Step 2: Import _Movie_  and _Genre_ data
...
Added 9145 labels, created 9145 nodes, set 137411 properties, created 20340 relationships.

== Step 3: Import _Person_ data
...
== Step 4: Import  the ACTED_IN relationships
...
== Step 5: Import  the DIRECTED relationships
