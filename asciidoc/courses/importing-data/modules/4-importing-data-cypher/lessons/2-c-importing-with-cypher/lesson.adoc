...
Added 9029 labels, created 9029 nodes, set 135932 properties, created 20112 relationships
...
Added 111 labels, created 111 nodes, set 193008 properties, created 96393 relationships
