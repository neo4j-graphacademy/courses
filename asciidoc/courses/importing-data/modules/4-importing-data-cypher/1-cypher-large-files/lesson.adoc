...
An Entity row has a value of Person, Movie, or Join. We will continue to use these unique IDs for our _Movie_, _Person_, and _Genre_ nodes:
...
. Add tne Director labels and the DIRECTED relationships.
