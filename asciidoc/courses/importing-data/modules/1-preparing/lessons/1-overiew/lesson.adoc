...
In this course, you will first learn how to import CSV files as it is the easiest way to import data from source files.
Later, you will learn how to import JSON data.
...
To import data using Cypher, the Neo4j DBMS must be started.
...
. Create the uniqueness constraints in the graph.

The steps that you use for preparing to import CSV data are similar to the steps you use for preparing to import other data file types.
