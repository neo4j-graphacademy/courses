...
After you understand the source data you have to work with and you also know the graph data model you need to implement, you can import the data into Neo4j with Cypher code.
...
In the next lesson, you will learn how source data may be organized.
