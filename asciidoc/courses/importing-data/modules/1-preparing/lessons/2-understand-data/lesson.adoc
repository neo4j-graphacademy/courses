...
If the size of the CSV files is extremely large, it is sometimes better to separate the headers from the data, especially if multiple files will be split to use the same set of headers.
...
In this course, you will be importing both normalized and denormalized data.
