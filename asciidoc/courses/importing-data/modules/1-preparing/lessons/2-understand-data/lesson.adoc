...
image::{repository-raw}/main/{path}/images/with-without-headers.png[With and without headers,width=600,align=center]
...
image::{repository-raw}/main/{path}/images/normalized-data.png[Normalized data,width=600,align=center]
...
image::{repository-raw}/main/{path}/images/denormalized-data.png[Denormalized data,width=600,align=center]
...
image::{repository-raw}/main/{path}/images/unique-ids.png[Unique Ids,width=600,align=center]
