...
[NOTE]
--
The Neo4j Data Importer may changed since this course was published.
You will see minor differences in the UI.

If you see nodes and relationships in the Graph Model pane, you should select all of them an delete them so you can start with a new mapping.
--
...
.. Notice that some property types do not match the graph data model. Modify them as follows:
... rating --> integer
... timestamp --> integer
