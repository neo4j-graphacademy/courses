...
Download the following file to your system:

https://data.neo4j.com/importing/movieData.zip

Uncompress this file. You should have these file:
...
... movie_poster --> poster
... movie_url --> url
.. Notice also that some of the property types do not match what our data model defines. Modify them as follows:
... budget --> integer
... imdbRating --> float
... imdbVotes --> integer
... revenue --> integer
