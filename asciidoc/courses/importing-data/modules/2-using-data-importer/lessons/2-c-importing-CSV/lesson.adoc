...
image::images/data-importer-c.png[Neo4j Data Importer,width=600,align=center]
...
image::images/data-importer-clear-all.png[Neo4j Data Importer,width=600,align=center]
