...
link:http://127.0.0.1:3000/workspace/import?acceptTerms=true&connectURL=neo4j://neo4j:neo@localhost:7687&cmd=guide&arg=graphacademy/importing-csv-data[Open the Challenge in Workspace →^,role=btn]
