...
In this lesson, you learned that if you want your properties to be something other than strings, integers, floats or booleans after using the Data Importer, you will need to post-process the graph.
