...
The Data Importer can be found here: https://data-importer.graphapp.io/

It is a graph app the allows you to load CSV files from your local system into the graph. With this graph app, you can examine the CSV file headers, and map them to nodes and relationships in a Neo4j graph.
