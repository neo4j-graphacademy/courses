...
The _User_ nodes are all set with string types for their properties. However, the _RATED_ relationship's _rating_ property needs to be transformed to an integer.
...
include::questions/1-storage-types.adoc[]
include::questions/2-string-to-date.adoc[]
