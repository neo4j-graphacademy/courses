...
It is a best practice to create list elements that all have the same type. For example:
...
Although our data model does not contain a genres property for Movie nodes, we will transform the data for this property as it will be a means to our goal of creating the Genre nodes in the graph.
...
include::questions/1-string-array.adoc[]
...
In the next Challenge, you will transform multi-value properties the graph you have been working with to list properties.