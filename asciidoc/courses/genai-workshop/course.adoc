...
:status: redirect
:redirect: /courses/workshop-genai/
:duration: 2 hours
:caption: GenAI Beyond Chat with RAG, Knowledge Graphs and Python
:usecase: recommendations
:key-points: Generative AI, Large Language Models, Retrieval-Augmented Generation (RAG), Knowledge Graphs, Integrating Neo4j using Python and LangChain
...
* Access to GitHub Codespaces (you will need a Github account) or a local Python environment
