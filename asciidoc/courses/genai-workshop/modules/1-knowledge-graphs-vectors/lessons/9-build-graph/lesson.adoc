...
[source, python]
----
include::{repository-raw}/main/1-knowledge-graphs-vectors/solutions/build_graph.py[get_embedding]
----
...
[source, python]
----
include::{repository-raw}/main/1-knowledge-graphs-vectors/solutions/build_graph.py[get_course_data]
----
...
[source, python]
----
include::{repository-raw}/main/1-knowledge-graphs-vectors/solutions/build_graph.py[openai]
----
...
[source, python]
----
include::{repository-raw}/main/1-knowledge-graphs-vectors/solutions/build_graph.py[neo4j]
----
...
[source, python]
----
include::{repository-raw}/main/1-knowledge-graphs-vectors/solutions/build_graph.py[create_chunk]
----
...
[source, python]
----
include::{repository-raw}/main/1-knowledge-graphs-vectors/solutions/build_graph.py[create]
----
...
[source, python]
----
include::{repository-raw}/main/1-knowledge-graphs-vectors/solutions/build_graph.py[close]
----
