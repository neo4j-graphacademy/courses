...
[source, python]
----
include::{repository-raw}/{branch}/1-knowledge-graphs-vectors/solutions/build_graph.py[tag=get_embedding]
----
...
[source, python]
----
include::{repository-raw}/{branch}/1-knowledge-graphs-vectors/solutions/build_graph.py[tag=openai]
----
...
[source, python]
----
include::{repository-raw}/{branch}/1-knowledge-graphs-vectors/solutions/build_graph.py[tag=close]
----
