...
. Create a link:https://python.langchain.com/docs/modules/data_connection/document_loaders/how_to/text_splitter[`CharacterTextSplitter`^] object to split the content into chunks of text.
