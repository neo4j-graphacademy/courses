...
The link:https://python.langchain.com/api_reference/neo4j/vectorstores/langchain_neo4j.vectorstores.neo4j_vector.Neo4jVector.html[`Neo4jVector`^] is a LangChain vector store that uses a Neo4j database as the underlying data structure.
