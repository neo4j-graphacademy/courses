...
4. To find the answer, click the Debug icon to the left of the window and run **Create Driver** job, or use the integrated terminal window to run the following command: +
+
.Run The Challenge
