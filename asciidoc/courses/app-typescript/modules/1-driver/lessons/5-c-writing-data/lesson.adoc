...
[source, typescript]
----
include::{repository-raw}/{branch}/{lab-file}[tag=cypher]
----
...
[source, typescript]
----
include::{repository-raw}/{branch}/{lab-file}[tag=params]
----
...
[source, typescript]
----
include::{repository-raw}/{branch}/{lab-file}[tag=execute]
----
...
[source, typescript]
----
include::{repository-raw}/{branch}/{lab-file}[tag=log_result]
----
