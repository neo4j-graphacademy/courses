...
In the Neo4j .NET Driver, exceptions of type link:https://neo4j.com/docs/api/java-driver/current/org/neo4j/driver/exceptions/Neo4jException.html[`Neo4jException`^] will be thrown by methods that run into failure conditions.
