...
As Neo4j is written in .NET (the _j_ in Neo4**j** stands for _Java_ after all), there are some discrepancies between the types stored in the Neo4j database and native C# types.
