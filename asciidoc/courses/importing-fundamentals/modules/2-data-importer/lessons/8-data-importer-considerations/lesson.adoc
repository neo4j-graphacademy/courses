...
You can learn more about link:https://neo4j.com/docs/data-importer/current/import-others/[Other ways of importing data into Neo4j^] in the Neo4j documentation and other GraphAcademy courses.
...
In the next module, you will explore how to evaluate your source data and preparing it for import into Neo4j.