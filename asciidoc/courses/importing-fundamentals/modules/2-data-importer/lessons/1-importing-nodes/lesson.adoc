...
You should update some of the default property names to be more concise:
...
Data importer will load the data from the CSV file and using your configuration create the data in the Neo4j database.

Once complete, you should see a summary of import, including counts of the nodes created and properties set. 
...
.Backup your work
====
Data importer saved changes automatically, but you can download your import model by selecting the `Download model` option from the menu `...`.

image::images/download-model-annotated.png[The download model option in the data importer menu '...']
====

=== View the data

You can view the data in the Neo4j using this Cypher, which returns the first 25 `Movie` nodes:
...
In this lesson, you learned how to use Data Importer to import nodes from a CSV file.
