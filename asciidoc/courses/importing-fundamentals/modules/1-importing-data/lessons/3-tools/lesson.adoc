...
If your Neo4j database is hosted on link:https://console.neo4j.io/graphacademy[Aura DB^] you can import data directly from several cloud hosted relational databases, including:
