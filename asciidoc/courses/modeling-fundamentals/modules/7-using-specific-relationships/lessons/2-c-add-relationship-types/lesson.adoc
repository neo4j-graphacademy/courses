...
. Rewrite and run the query using the specialized relationships for the use case:  *What reviewers gave a movie a rating of 5?*
...
Modify and run this query for the use case so that it uses the specialized relationships.
