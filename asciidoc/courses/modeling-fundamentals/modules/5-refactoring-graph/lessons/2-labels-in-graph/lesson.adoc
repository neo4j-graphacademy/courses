...
What if we added a new domain question:

*10. What actors were born before 1950?*

The Cypher query for this question is the following. Execute this query:
...
With the refactoring we change the Cypher query for this question to:
...
After you have refactored the graph, you should revisit all queries for the questions of your domain.
