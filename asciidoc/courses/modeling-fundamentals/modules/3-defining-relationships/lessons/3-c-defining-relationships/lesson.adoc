...
We have an additional use case that we must model for asking a question about reviewers who rated movies.
We have defined the _User_ label to represent reviewers.
