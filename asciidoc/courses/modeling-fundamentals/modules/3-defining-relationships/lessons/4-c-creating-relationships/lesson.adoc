...
Use the sandbox window to the right to add more `MERGE` clauses to continue the creation of the _RATED_ relationships between these nodes with the _rated_ property as follows:
