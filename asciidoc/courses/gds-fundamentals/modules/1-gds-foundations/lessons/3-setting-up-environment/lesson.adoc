...
Before you continue the course, run the following query to ensure you have correctly installed the GDS plugin:
...
If you do not see a GDS version, check the instructions again to ensure you have followed the steps correctly.
...
* Download link:https://github.com/neo4j-graph-examples/recommendations/blob/main/data/recommendations-50.dump[this .dump file^]
* From your DBMS menu, select **Load database from file**
