...
3. First configuration map (empty - using defaults)
4. Second configuration map (empty - using defaults)
5. Yield node IDs and PageRank scores
6. Convert node IDs to names and return with scores
