...
You now understand what monopartite graphs are and why GDS creates them by default. You've seen how the graph structure affects algorithm results. In the next lesson, you'll get hands-on practice creating different types of monopartite projections.
