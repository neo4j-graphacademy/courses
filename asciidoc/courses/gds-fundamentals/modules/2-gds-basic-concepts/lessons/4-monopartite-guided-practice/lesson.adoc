...
**Key insight:** "Importance" or "centrality" only has meaning relative to the relationships being analysed. We haven't found the most culturally significant movies—we've found movies whose casts create the most connections in our actor collaboration network.
