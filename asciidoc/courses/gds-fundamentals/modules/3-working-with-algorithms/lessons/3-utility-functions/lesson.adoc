...
.Extract actor name and community
----
CALL gds.louvain.stream('actor-network', {})
YIELD nodeId, communityId
...
You now understand how to convert internal node IDs into actual database nodes using `gds.util.asNode()`. This is essential for making streamed algorithm results readable and useful. In the next lesson, you'll learn how to read the GDS documentation to understand algorithm requirements, configurations, and capabilities.
