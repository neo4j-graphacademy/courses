...
====
For undirected relationships, place `undirectedRelationshipTypes: ['*]` inside the second set of curly brackets.
====
...
====
[source,cypher]
.Create unweighted User-Movie projection
----
...
You've seen how relationship orientation and weights affect algorithm results. In the next lesson, you'll put this knowledge to the test with a challenge: projecting a weighted graph and analyzing it using Label Propagation, a community detection algorithm you'll explore through the GDS documentation.
