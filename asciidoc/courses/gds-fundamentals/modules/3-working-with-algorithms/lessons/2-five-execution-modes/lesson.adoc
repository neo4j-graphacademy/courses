...
You've practiced all five execution modes and understand when to use each one. In the next lesson, you'll learn about GDS utility functions that help you work with algorithm results, specifically how to extract node properties from streamed results.
