...
|===
| {set:cellbgcolor:#f5f5f5}**Attribute**                   | {set:cellbgcolor: #e8f5e9}✓ Green                                  | {set:cellbgcolor: #fff3e0}✓ Amber                                   | {set:cellbgcolor: #ffebee}x Red
| {set:cellbgcolor:#ffffff}**Directed**                    | {set:cellbgcolor: #e8f5e9}Runs well on directed graphs             | {set:cellbgcolor: #fff3e0}Runs but ignores directionality          | {set:cellbgcolor: #ffebee}Does not run on directed graphs
| {set:cellbgcolor:#ffffff}**Undirected**                  | {set:cellbgcolor: #e8f5e9}Runs well on undirected graphs           | {set:cellbgcolor: #fff3e0}Runs but ignores directionality          | {set:cellbgcolor: #ffebee}Does not run on undirected graphs
| {set:cellbgcolor:#ffffff}**Heterogeneous nodes**         | {set:cellbgcolor: #e8f5e9}Can consider node labels                 | {set:cellbgcolor: #fff3e0}Runs but ignores node labels             | {set:cellbgcolor: #ffebee}Does not run on graphs with labels
| {set:cellbgcolor:#ffffff}**Heterogeneous relationships** | {set:cellbgcolor: #e8f5e9}Can consider multiple relationship types | {set:cellbgcolor: #fff3e0}Runs but ignores relationship types      | {set:cellbgcolor: #ffebee}Does not run on graphs with multiple relationship types
| {set:cellbgcolor:#ffffff}**Weighted relationships**      | {set:cellbgcolor: #e8f5e9}Can consider relationship properties     | {set:cellbgcolor: #fff3e0}Runs with properties, but ignores them   | {set:cellbgcolor: #ffebee}Does not run on graphs with relationship properties
|===
