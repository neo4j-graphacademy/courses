...
. Aggregate relationships during projection to create meaningful weights
. Design projections that match your analytical questions
. Run complete GDS workflows from question to projection to analysis
