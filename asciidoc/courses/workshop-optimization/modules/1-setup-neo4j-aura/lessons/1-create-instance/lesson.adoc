...
[.col]
====
Create an account on link:https://console.neo4j.io/graphacademy[Neo4j Aura (console.neo4j.io)^] and complete the onboarding process.
...
=====
If you can't create an Aura instance, you can add the Sandbox that was created when you enrolled on the course as a *Self-managed* instance in the link:https://console.neo4j.io/graphacademy[Aura console^].
...
+
Connection URL:: [copy]#https://{instance-host}:443#
