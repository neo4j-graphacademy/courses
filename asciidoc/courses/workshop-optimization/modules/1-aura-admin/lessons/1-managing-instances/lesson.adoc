...
.Aura Instance
====
You will be using Aura throughout this workshop. Please create an instance if you don't already have one. 

You can use the free tier for this workshop, but a professional tier instance is recommended for access to the complete feature set.
====

=== Data load

TODO - load the data you will need
