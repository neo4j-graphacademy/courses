...
We have created a link:https://github.com/neo4j-graphacademy/genai-workshop-graphrag[repository^] for this workshop.
...
Clone the link:https://github.com/neo4j-graphacademy/genai-workshop-graphrag[github.com/willtai/genai-workshop] repository:
