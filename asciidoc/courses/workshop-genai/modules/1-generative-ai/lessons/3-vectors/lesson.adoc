...
In this lesson, you learned about vectors, embeddings, and similarity search.

In the next module, you will use Python to create retrievers that use vectors and Cypher to find information in the knowledge graph.
