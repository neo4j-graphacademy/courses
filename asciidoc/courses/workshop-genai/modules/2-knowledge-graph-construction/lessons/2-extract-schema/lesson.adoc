...
.Extracted Schema
----
include::diagrams/model.mermaid[]
----
====
...
* [copy]#Python is a programming language created by Guido van Rossum.#
* [copy]#The Eiffel Tower is a wrought-iron lattice tower on the Champ de Mars in Paris, France.#
* [copy]#Large Language Models (LLMs) are a type of artificial intelligence model designed to generate human-like text.#
