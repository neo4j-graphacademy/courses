...
Providing a schema allows you to create a more structured and meaningful knowledge graph. 
The pipeline instructs the LLM to only identify the specified nodes and relationships
