...
[.transcript-only]
====
For example, the embedding for the word "apple" is `0.0176544189453125, -0.0168304443359375, -0.041900634765625, 0.0190277099609375, -0.00177001953125, -0.02691650390625, 0.00728607177734375, 0.0228729248046875, -0.01959228515625, -0.0167083740234375, 0.021942138671875, 0.0050506591796875, -0.0513916015625,,` ... and so on.
...
.Embedding models
=====
OpenAI's `text-embedding-3-small` embedding model created this embedding - a vector of 1,536 dimensions.
