...
[.slide-only]
====
**Continue with the lesson to experiment with the agent.**
====
...
* [copy]#What questions can I answer using this graph database?#
* [copy]#How are concepts related to other entities?#
* [copy]#How does the graph model relate technologies to benefits?#
