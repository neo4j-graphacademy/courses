...
You task is to modify the `agent.py` code to:
...
[.slide-only]
====
**Continue with the lesson to add the search lesson tool.**
====
...
* [copy]#How are Knowledge Graphs associated with other technologies?#
* [copy]#Summarize what concepts are associated with Knowledge Graphs?#
* [copy]#How would you minimize hallucinations in LLMs?#
