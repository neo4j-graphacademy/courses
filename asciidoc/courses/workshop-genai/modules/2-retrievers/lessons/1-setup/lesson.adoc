...
.Create a .env file
----
include::{repository-raw}/{branch}/.env.example[2..]
----
...
In the next lesson, you will learn about the different types of retrievers and how to use them.

link:../2-retrievers/[Continue to Retrievers →, role=btn]
