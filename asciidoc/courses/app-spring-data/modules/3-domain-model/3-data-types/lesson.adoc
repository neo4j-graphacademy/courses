...
----
include::{nodejs-repository-raw}/main/example/results.js[tag=integers]
----
...
[source,js,role=ncopy,subs="attributes+",indent=0]
----
include::{nodejs-repository-raw}/main/example/results.js[tag=run]

include::{nodejs-repository-raw}/main/example/results.js[tag=row]
----
...
[source,js,role=ncopy,subs="attributes+",indent=0]
----
include::{nodejs-repository-raw}/main/example/results.js[tag=get]
----
...
[source,js,role=ncopy,subs="attributes+",indent=0]
----
include::{nodejs-repository-raw}/main/example/results.js[tag=node]
----
...
[source,js,role=ncopy,subs="attributes+",indent=0]
----
include::{nodejs-repository-raw}/main/example/results.js[tag=rel]
----
...
[source,js,role=ncopy,subs="attributes+",indent=0]
----
include::{nodejs-repository-raw}/main/example/results.js[tag=path]
----
...
[source,js,role=ncopy,subs="attributes+",indent=0]
----
include::{nodejs-repository-raw}/main/example/results.js[tag=segments]
----
...
[source,js,role=ncopy,subs="attributes+",indent=0]
----
include::{nodejs-repository-raw}/main/example/results.js[tag=temporal]
----
...
----
include::{nodejs-repository-raw}/main/src/utils.js[tag=toNativeTypes]
----
====
