...
In your application, create a new Java class called `Role.java` in the `src/main/java/com/example/appspringdata` package. This class will represent the relationship properties stored on the relationship between a `Person` and a `Movie` node.
