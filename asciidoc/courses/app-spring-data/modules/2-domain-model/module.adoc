...
In this module, you will learn about the application domain model, how it relates to the Neo4j graph data model, and how to map the data model for your project.
