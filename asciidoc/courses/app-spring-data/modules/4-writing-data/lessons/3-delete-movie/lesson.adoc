...
Run your application. Once the application is running, open a browser and navigate to `http://localhost:8080/movies/delete?movieId=9876` to delete the `MyMovie` node created in the last lesson.
