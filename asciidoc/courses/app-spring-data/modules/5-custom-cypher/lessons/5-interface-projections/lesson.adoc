...
To create a projection, create an interface called `MovieProjection` in the `src/main/java/com/example/appspringdata` folder. Then call the getter methods of the desired properties for `title`, `released`, and `poster`.
