...
The output from the chain is string and you would typically specify an link:https://python.langchain.com/docs/modules/model_io/output_parsers/[output parser^] to parse the output of the LLM.
...
[source,python]
----
include::code/llm_chain_outpu_json.py[tag=import]
