...
Langchain also provides out-of-the-box integrations with APIs and databases including link:https://python.langchain.com/docs/integrations/providers/neo4j[Neo4j^].
...
// TODO: need a different example, which includes a prompt template
...
In the next lesson, you will learn how to connect to Neo4j in a Langchain application.
