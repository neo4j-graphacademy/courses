...
As each call to the LLM is stateless, you need to include the chat history in every call to the LLM. You can do this by modifying the prompt template to include the chat history in a variable.
