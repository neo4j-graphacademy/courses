...
In the next lesson, you will then use the link:https://python.langchain.com/docs/integrations/memory/neo4j_chat_message_history/[Neo4j Chat Message History] memory component to persist the conversation history in a Neo4j database.
