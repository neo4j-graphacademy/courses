...
In the next lesson, you will then use the link:https://python.langchain.com/api_reference/neo4j/chat_message_histories/langchain_neo4j.chat_message_histories.neo4j.Neo4jChatMessageHistory.html[Neo4j Chat Message History] memory component to persist the conversation history in a Neo4j database.
