...
[source,python]
----
include::../3-chat-models/code/chat-model-context.py[tags=**]
----
====
...
[source, python]
----
include::code/chat-model-memory.py[tags=import-messages]

include::code/chat-model-memory.py[tags=prompt]
----
...
[source, python]
----
include::code/chat-model-memory.py[tags=import-memory]

include::code/chat-model-memory.py[tags=memory]
----
...
[source, python]
----
include::code/chat-model-memory.py[tags=import-runnable]

include::code/chat-model-memory.py[tags=chat-history]
----
...
[source, python]
----
include::code/chat-model-memory.py[tags=loop]
----
...
[source,python]
----
include::code/chat-model-memory.py[tags=**]
----
====
