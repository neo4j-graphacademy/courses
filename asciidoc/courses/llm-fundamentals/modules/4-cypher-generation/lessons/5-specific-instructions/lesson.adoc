...
[source,python]
----
include::../1-cypher-qa-chain/code/cypher-gen.py[tags=template]
----
...
[source,python]
----
include::code/cypher-gen-follow-schema.py[tags=template]
----
...
[source, python]
----
include::code/cypher-gen-understand-data.py[tags=template]
----
