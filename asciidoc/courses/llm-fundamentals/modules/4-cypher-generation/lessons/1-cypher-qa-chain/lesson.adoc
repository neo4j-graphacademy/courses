...
[source,python]
----
include::code/cypher-gen.py[tags=**]
----
...
[source,python]
----
include::code/cypher-gen.py[tags=openai-neo4j]
----
. The `CYPHER_GENERATION_TEMPLATE` gives the LLM context. The schema and question are passed to the LLM as input variables.
+
[source,python]
----
include::code/cypher-gen.py[tags=template]

include::code/cypher-gen.py[tags=prompt]
----
+
...
[source,python]
----
include::code/cypher-gen.py[tags=cypher-chain]
----
+
...
[source,python]
----
include::code/cypher-gen.py[tags=invoke]
----
