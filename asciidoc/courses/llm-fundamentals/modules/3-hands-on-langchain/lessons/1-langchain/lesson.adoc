...
To build our Neo4j and LLM integration, we will use a framework called Langchain.
...
Let's take a simple example that allows a user to ask questions about a PDF document.
The application will use **Retrieval Augmented Generation** to pass similar text to the user's input the LLM.

The application may consist of:
