...
// TODO - Diagram of LLMs as black boxes. A question goes in and response comes out but the inner workings are unknown.
...
// TODO diagram of a new agency chatbot with grounding to a news API
