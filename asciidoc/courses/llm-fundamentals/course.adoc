...
:categories: context-engineer:2, generative-ai:21, build-applications:24, genai
:status: disabled
...
:key-points: Neo4j and Generative AI fundamentals, Large Language Models, Retrieval Augmented Generation (RAG), Using Neo4j with Langchain
