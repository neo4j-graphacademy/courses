...
[NOTE]
The `verifyConnectivity()` method will raise an link:https://neo4j.com/docs/api/python-driver/current/api.html#errors[exception^] if the connection cannot be made.
