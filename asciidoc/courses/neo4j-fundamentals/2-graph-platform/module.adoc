...
video::n4jWY5ES1Dw[youtube,width=560,height=315]
...
The Neo4j Graph Database Platform includes components that enable you to develop your graph-enabled application.
