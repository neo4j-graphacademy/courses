...
In this lesson you will learn about the additional elements that Neo4j supports to make a *labeled property graph*.
...
By looking at the _name_ property on the Graph Inc node, we can see that it refers to the company *Graph Inc*, with a _city_ of *London*, has 56 employees (_numEmployees_), and does business as Graph Inc and GI (_dba_).
