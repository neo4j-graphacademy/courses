...
The relationships between objects in a graph is the most important characteristic of the graph.
...
* Whenever you enter a land mass via a bridge, you must leave it by a different bridge. Except at the start (where you leave but do not enter) and at the end (where you enter but do not leave).
...
For example, the Internet can be modeled as a network of computers that are connected (related).

image::images/TheInternetAsAGraph.png[TheInternetAsAGraph,width=400,align=center]

At the other extreme of complexity, a single molecule can be represented as a graph of its constituent atoms--or an atom represented as a graph of subatomic particles where these particles are related to other particles.
...
include::questions/1-relationships.adoc[]

include::questions/2-euler.adoc[]

[.summary]
== Summary

In this lesson, you learned about the foundation of graph theory based upon the work of Leonhard Euler and you learned how graphs can be simple or complex.
