...
He realised that the land masses themselves weren’t an important factor.  In fact, it was the bridges that connected the land masses that were the most important thing.

His approach was to define the problem in abstract terms, taking each landmass and representing it as an abstract *vertex* or _node_, then connecting these land masses together with a set of seven *edges* that represent the bridges.  These elements formed a “Graph”.
