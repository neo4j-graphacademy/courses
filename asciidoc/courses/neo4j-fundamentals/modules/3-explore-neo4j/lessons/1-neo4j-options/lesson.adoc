...
You can create a free Neo4j instance at link:https://console.neo4j.io/graphacademy[console.neo4j.io^] and scale it up or down as needed.
...
link:https://console.neo4j.io/graphacademy[Neo4j AuraDB^] and link:https://neo4j.com/download/[Neo4j Desktop^] provide the easiest way to start with Neo4j.
