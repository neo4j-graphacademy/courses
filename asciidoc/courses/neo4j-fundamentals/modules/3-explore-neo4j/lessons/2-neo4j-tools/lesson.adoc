...
image::images/neo4j-console.png[A screenshot of the Neo4j Console]
...
image::images/console-import.png[A screenshot of the Neo4j Import user interface]
...
image::images/console-explore.png[A screenshot of Neo4j bloom]
...
image::images/console-query.png[A screenshot of the query tool]
...
Learn more in the link:https://graphacademy.neo4j.com/courses/cypher-fundamentals/[Cypher Fundamentals course^].

== Check Your Understanding

include::./questions/1-data-importer.adoc[leveloffset=+1]
