...
Once you have created your favorite movie an duser node, click the **Check database** button and we will check the database to make sure you have completed the challenge.
