...
You will need to modify the filter to use the `name` '[copy]#Emil Eifrem#'.
...
.Hint
====
You will need to modify the `WHERE` clause from filtering for 'Tom Hanks' to filter to [copy]#Emil Eifrem#
