...
Neo4j is a graph database. Graph databases are particularly useful when _the connections between data are as important as the data itself_.
...
In the next lesson, you will learn how to apply graph thinking to solve real-world problems.
