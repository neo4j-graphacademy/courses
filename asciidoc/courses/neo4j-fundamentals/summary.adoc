...
You can create a free link:https://console.neo4j.io/graphacademy[Neo4j AuraDB instance^] or download link:https://neo4j.com/download/[Neo4j Desktop^] to get a free Neo4j database to support your learning.
