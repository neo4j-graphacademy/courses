...
The JVM pauses briefly during garbage collection to clean up unused memory. During these pauses, query execution may be delayed. The goal is to minimize the frequency and duration of these pauses to maintain consistent performance.
