...
Understanding your database storage helps you plan capacity and control costs. As you add and delete data, the database allocates and uses space differently.
