...
.Hint
====
Checkpoints typically run every 15 minutes. Normal checkpoints take several seconds to several minutes. Aura has a lower threshold than self-managed Neo4j.
====
