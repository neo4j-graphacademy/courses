...
Note that deleting data doesn't immediately reduce storage—the space is marked for reuse. You'll learn more about how storage can be reclaimed later in the course.
====
