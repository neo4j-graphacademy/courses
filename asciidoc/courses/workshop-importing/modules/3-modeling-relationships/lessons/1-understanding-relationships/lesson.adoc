...
In the previous lesosn, you imported Product nodes. Nodes represent entities, but relationships connect them together to enable complex queries about how entities relate.
...
[.slide]
== Choosing between direct relationships and intermediate nodes
...
[.slide]
== Why Northwind uses Order nodes
...
[.slide]
== Deciding when to promote relationships to nodes
