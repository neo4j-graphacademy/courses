...
* Import Product nodes (required)
* Optional: Import Customer, Order, and Category nodes
* Optional: Import IN_CATEGORY relationships
...
* Import PLACED relationships (Customer→Order)
...
* Import CONTAINS relationships (Order→Product)
