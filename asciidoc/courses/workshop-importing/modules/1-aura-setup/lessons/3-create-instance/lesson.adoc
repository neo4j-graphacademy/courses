...
In the previous lesson, you learned about Neo4j Aura and the different tiers available. You saw that the Aura Free tier is perfect for this workshop.

Now it's time to create your own Aura Free instance that you'll use throughout the workshop.


In this lesson, you will create your Neo4j Aura Free instance and save your connection credentials.
