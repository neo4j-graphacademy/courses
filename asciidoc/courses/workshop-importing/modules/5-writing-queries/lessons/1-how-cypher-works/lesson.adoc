...
[.slide]
== Step 2: Following Relationships
...
[.slide]
== Indexes and Constraints: Query Performance
...
[.slide]
== How Constraints Improve CONTAINS Queries
