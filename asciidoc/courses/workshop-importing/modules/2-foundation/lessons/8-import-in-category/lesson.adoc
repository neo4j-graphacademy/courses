...
[.slide.discrete]
== Import IN_CATEGORY Relationships

**This lesson is optional.** IN_CATEGORY relationships enrich recommendations but aren't required for the basic collaborative filtering query.

You've imported Product and Category nodes separately. Now connect them by creating IN_CATEGORY relationships.

**In this challenge, you will import IN_CATEGORY relationships on your own.**
...
[.slide]
== Why Categories Enable Richer Recommendations
