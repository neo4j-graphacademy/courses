...
2. In the details panel, find the **Table** dropdown under the Definition tab
...
[.col]
====
Once a data source is mapped, you'll see properties listed in the **Definition** tab of the details panel.
...
[.col]
====
Once you create a relationship, select it to configure its properties in the **Definition** tab of the details panel.
