...
Our current Northwind model works well, but let's consider some potential refactorings:
...
We could extract a Shipper node:
...
Don't refactor just for the sake of it. Avoid refactoring when:
...
* What refactoring is and why it's valuable
