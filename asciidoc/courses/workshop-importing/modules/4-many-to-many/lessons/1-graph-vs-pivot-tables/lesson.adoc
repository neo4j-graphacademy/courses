= Graph vs Pivot Tables: The Many-to-Many Problem
:type: lesson
:order: 1
...
|===
| What | How
| Store connection | Direct ORDERS relationship
| Query | Traverse relationship (Order)-[:ORDERS]->(Product)
...
* ⏳ Order → Product (ORDERS relationships - you'll create this next)
...
The ORDERS relationship is **the most critical piece** of the recommendation system:
...
In the next lesson, you'll create these ORDERS relationships and complete the Customer→Order→Product path.
...
* **Graph solution** - Direct ORDERS relationships with properties (quantity, unitPrice)
...
In the next lesson, you will create ORDERS relationships and complete the path.
