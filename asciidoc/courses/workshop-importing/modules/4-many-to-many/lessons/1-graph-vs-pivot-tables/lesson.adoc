...
In this lesson, you will learn why many-to-many relationships require pivot tables in relational databases and how graphs handle them with direct connections.
...
[.slide]
== How relational databases use pivot tables
...
[.slide]
== Using direct relationships in graphs
...
[.slide]
== Transforming tables to relationships
