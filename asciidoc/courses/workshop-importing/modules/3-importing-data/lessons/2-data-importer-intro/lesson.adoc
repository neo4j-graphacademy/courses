...
In the previous lesson, you learned about different import options in Neo4j.


In this lesson, you will explore the Data Importer tool and learn how to use it to import CSV files into your graph database.
