...
Now that all nodes are defined, it's time to create relationships between them. Relationships connect entities and make the graph useful for queries.
...
In this lesson, you created all six relationships:

1. **Customer PLACED Order** - Links customers to their orders
2. **Product PART_OF Category** - Categorizes products
3. **Product SUPPLIED_BY Supplier** - Links products to suppliers
4. **Order ORDERS Product** - Order line items with quantity, price, discount
5. **Employee SOLD Order** - Links employees to orders they processed
6. **Employee REPORTS_TO Employee** - Employee hierarchy
