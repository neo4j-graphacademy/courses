...
In the previous lesson, you learned about the Data Importer tool and its interface.
...
Open the Data Importer in your Aura instance.
...
This will create a uniqueness constraint.
