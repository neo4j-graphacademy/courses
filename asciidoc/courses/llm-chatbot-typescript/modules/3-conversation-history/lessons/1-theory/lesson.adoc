...
In this lesson, you learned the benefits of saving the conversation memory in the same database as the data.

In the next lesson, you will take a look at how the conversation memory should be modelled.
