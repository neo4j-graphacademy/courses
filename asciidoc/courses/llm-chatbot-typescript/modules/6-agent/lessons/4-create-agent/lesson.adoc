...
The link:https://smith.langchain.com/hub/search?q=hwchase17/openai-functions-agent[`hwchase17/openai-functions-agent` prompt^] has been written to work with OpenAI Function agents.
...
Luckily, you link:/courses/llm-chatbot-typescript/3-conversational-history/[built the functionality in the Conversation History module^].
