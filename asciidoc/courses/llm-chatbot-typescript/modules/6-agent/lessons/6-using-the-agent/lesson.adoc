...
To interact with the graph, the agent should use link:/courses/llm-chatbot-typescript/3-conversational-history/2-neo4j-graph/[the singleton instance created in the Initializing Neo4j lesson^].
