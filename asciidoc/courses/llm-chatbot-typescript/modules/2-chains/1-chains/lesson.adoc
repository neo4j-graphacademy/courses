...
[source,typescript]
----
include::{repository-include}/examples/chain.mjs[tag=prompt]
----
...
[source,typescript]
----
include::{repository-include}/examples/chain.mjs[tag=llm]
----
...
[source,typescript]
----
include::{repository-include}/examples/chain.mjs[tag=chain]
----
...
[source,typescript]
----
include::{repository-include}/examples/chain.mjs[tag=invoke]
----
...
[source,typescript]
----
include::{repository-include}/examples/chain.mjs[tag=types]
----
====
