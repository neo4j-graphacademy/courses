...
[source,typescript]
----
include::{repository-raw}/{branch}/{lab-solution}[tag=vectorstore, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/{lab-solution}[tag=retriever, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/{lab-solution}[tag=getcontext, indent=0]
----
