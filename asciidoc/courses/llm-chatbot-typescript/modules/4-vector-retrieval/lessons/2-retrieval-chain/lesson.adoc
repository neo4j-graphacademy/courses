...
Now that you have a vector store, you can use it to retrieve chunks of text that answer user questions.
...
2. Create an instance of the link:../../2-chains/1-answer-generation/[Answer Generation chain^].
...
[source,typescript]
----
include::{repository-raw}/{branch}/src/{lab-file}[tag=function, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/src/{lab-file}[tag=vectorstore, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/src/{lab-file}[tag=retriever, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/src/{lab-file}[tag=answerchain, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/src/{lab-file}[tag=getcontext, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/src/{lab-file}[tag=extractDocumentIds, indent=0]

include::{repository-raw}/{branch}/src/{lab-file}[tag=docsToJson, indent=0]
----
...
[source,typescript]
----
include::{repository-raw}/{branch}/{lab-solution}[tags="getcontext,mutatecontext", indent=0]
----
