...
:categories: cypher:2, start:5, software-development:5, data-analysis:5, reporting:5, llms:5, intermediate:1, coredb
:next: cypher-indexes-constraints
:status: active
:duration: 4 hours
:video: https://www.youtube.com/embed/-ogo_gls068
:key-points: Filtering queries, Controlling results, Graph traversal, Pipelining queries, Subqueries
