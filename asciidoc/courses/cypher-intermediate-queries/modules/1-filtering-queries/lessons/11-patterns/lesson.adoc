...
// DONE: Elaine, I'm not sure this sentence makes sense?
// Modified sentence
...
[NOTE]
--
Query tuning is beyond the scope of this course, but it is important to profile your queries so that you can optimize the queries of your application.
