...
// TODO: Elaine, I'm not sure this sentence makes sense?
...
This query retrieves the anchor of the query, the Tom Hanks `:Person` node.
...
That is, the first PROFILE of a query will be more expensive than subsequent queries.
