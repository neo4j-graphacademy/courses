...
// TODO: Elaine, also mention EXPLAIN in this and the differences between?  Should this go in an advanced course?
...
If you execute the profile for this query twice, you will see that it executes in ~11-12 ms.
...
If you execute the profile for this query twice, you will see that it executes in ~12 ms.
Remember that the performance of your queries will greatly depend on the data model.
As you gain experience with Cypher, you will learn how to write performant queries.
