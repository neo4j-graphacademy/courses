...
Notice that in this code we are specifying aliases for the column headers for each row.
...
This query returns many rows at the beginning of the result set that have a null value for the born property.
