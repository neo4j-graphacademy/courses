...
There are a number of other types of data such as _Time_, _LocalTime_, _LocalDateTime_,  _Timestamp_, and _Duration_ which are described in the link:https://neo4j.com/docs/cypher-manual/current/functions/temporal/[Temporal Functions section of the Neo4j Cypher Manual^].
...
[NOTE]
--
You can set a Date property using a <ISO-datetime> string.
--
