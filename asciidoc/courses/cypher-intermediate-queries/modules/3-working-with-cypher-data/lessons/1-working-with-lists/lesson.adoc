...
[NOTE]
--
As you gain more experience with query tuning, you will learn that `count()` may be more efficient because it gets its values from the internal count store of the graph.
--
