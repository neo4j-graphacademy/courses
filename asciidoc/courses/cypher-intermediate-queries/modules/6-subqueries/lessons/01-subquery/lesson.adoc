...
In a `CALL` clause, you specify a query that can returns data from the graph or derived from the graph.
...
With this query 100 Person nodes are retrieved and passed to the subquery.
