...
It includes a graph app called  Neo4j Browser which is the UI you use to access the started database using Cypher queries.
...
include::questions/1-desktop.adoc[leveloffset=+1]
