...
The sandbox window on the right creates one relationship between Sandy Jones and Apollo 13 with a rating of 5. Add additional `MERGE` code in the query edit pane to create the remaining 4 relationships per the table below:

*Note*: The first `MERGE` is already written for you.
