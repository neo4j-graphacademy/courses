...
include::questions/question-1.adoc[]

include::questions/question-2.adoc[]

include::questions/question-3.adoc[]

[.summary]
== Summary

In this module, we saw how to use GraphQL type definitions to generate a GraphQL API using the Neo4j GraphQL Library. In the next module we explore adding custom logic to our GraphQL API using the Cypher query language.
