...
However, it's important to understand how to install and get started with the Neo4j GraphQL Library.
...
This program which uses the Neo4j GraphQL Library to generate a GraphQL schema and start a *local* GraphQL API.
...
The GraphQL Playground IDE will also be served at link:http://localhost:4000[https://localhost:4000] which you can use to query the API and explore documentation using GraphQL's introspection feature.
