...
You can host your GraphQL API on link:https://console.neo4j.io/graphacademy[Neo4j Aura DB^] or setup your own server.

== GraphQL for Neo4j AuraDB

You can setup GraphQL Data APIs on any Aura DB instances (excluding free).

You create a new GraphQL Data API using the link:https://console.neo4j.io/graphacademy[Aura DB console^].
