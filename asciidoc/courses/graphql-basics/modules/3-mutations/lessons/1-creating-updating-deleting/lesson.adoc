...
Until now we've focused on the Query API of the Neo4j GraphQL Library. In this section you will learn about GraphQL mutation operations that create, update, or delete nodes and their properties in the database.
...
Typically an update mutation operations would be used with a `where` argument to filter for the node(s) you want to update. 
