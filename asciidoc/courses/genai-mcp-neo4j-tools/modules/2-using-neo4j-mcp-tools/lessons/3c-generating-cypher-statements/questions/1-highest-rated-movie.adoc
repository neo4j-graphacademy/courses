...
.Hint
====
Use the agent to ask about finding the highest rated movie. You can ask:
...
The agent should generate and execute a Cypher query that returns the movie with the highest IMDB rating.
====
