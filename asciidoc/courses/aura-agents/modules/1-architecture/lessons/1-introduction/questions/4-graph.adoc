...
The agent queries your AuraDB instance using tools such as Cypher Template, Text2Cypher, and Similarity Search to retrieve relevant facts. Those results ground the LLM's answer, making it specific to your data rather than relying on what the LLM was trained on.
====
