...
[source,mermaid]
.Agent components: perceive, reason, act with tools, retrieval, and knowledge base
----
%%{init: {
  "theme": "base",
...
The agent perceives input, reasons about which tools to use, and acts by invoking tools and fetching retrieval context from the knowledge base. Retrieval queries both the graph and vector index in Neo4j.
...
In this lesson, you learned the core components: LLM, tools, knowledge base, and orchestrator.
