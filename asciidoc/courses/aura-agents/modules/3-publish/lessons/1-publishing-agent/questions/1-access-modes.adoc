...
.Hint
====
Internal means only the Aura Console preview. External exposes endpoints that applications like Cursor use to send messages. MCP hosts need External and the MCP toggle.
====
