...
A **Neo4j Aura Agent** is a no/low-code platform in the Aura Console where natural language questions turn into graph queries and are run in your knowledge graph. You connect the agent to an AuraDB instance, ask a question, and the agent handles the rest.
