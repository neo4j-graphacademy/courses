...
Ask questions that only Text2Cypher can answer, where no Cypher Template fits. Then trace the generated Cypher and results. Optionally, improve the Text2Cypher tool description with when-to-use and domain context so the generated Cypher is more accurate.

== Before you start

* Use the agent you created with AI in Module 1 on your knowledge graph or Northwind. That agent includes a Text2Cypher tool by default.
* Open the agent in the Aura Console: **Data Services** → **Agents**, then select your agent.
* Ensure the preview panel is visible. That is the chat panel on the right where you can ask questions.
