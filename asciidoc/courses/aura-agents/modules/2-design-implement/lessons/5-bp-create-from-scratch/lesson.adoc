...
In this lesson, you will learn how to define role and scope, map question types to Cypher Template or Text2Cypher, and write tool descriptions so the LLM selects the right tool.
...
Review your Northwind agent (or the one you created with AI in Module 1) against the design above: check that role and scope are clear, question types map to Cypher Template or Text2Cypher, and tool descriptions are specific enough for the LLM to select the right tool.
...
include::questions/3-configuration-methods.adoc[leveloffset=+1]
