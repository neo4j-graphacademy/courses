...
In this challenge, you will add one Cypher Template tool to the agent you created with AI in Module 1. Use the agent you built on your own knowledge graph. If you prefer a working example, use the one you built with AI on Northwind.
...
* **The parameter**: name, type, and description.
