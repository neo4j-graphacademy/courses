...
// See link:https://neo4j.com/docs/aura/aura-agent/[Aura Agent documentation^] for MCP setup; add your agent's endpoint as a remote MCP server in Cursor's configuration.
