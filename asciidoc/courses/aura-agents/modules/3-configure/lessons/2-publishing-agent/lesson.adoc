...
Before an agent can be called from external applications, you need to change its access mode from Internal to External and enable the MCP server.
...
If you are not a Project Admin, ask your Organisation Admin to update your role.
====
