...
image::images/shortestpath.svg[a graph showing all the shortest paths between Baltimore and Frankfurt. There are so many relationships its difficult to see any detail.]
