...
It then uses `reduce()` with a starting value of 0. Finally, it adds each element to t to return the total of all elements in the list.
...
include::questions/1-scalar.adoc[leveloffset=+1]
include::questions/2-scalar.adoc[leveloffset=+1]
