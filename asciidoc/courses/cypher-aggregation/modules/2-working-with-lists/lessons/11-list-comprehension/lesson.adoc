...
Here is an example where we simply return subset of the list where the values in the countries list property are either USA or Germany or both:
...
include::questions/1-list-comprehension.adoc[leveloffset=+1]
include::questions/2-list-comprehension.adoc[leveloffset=+1]
