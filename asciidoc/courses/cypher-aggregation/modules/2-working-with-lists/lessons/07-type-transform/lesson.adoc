...
Numeric elements with a value of 1 will be transformed to true.


== Check your understanding

include::questions/1-type-transform.adoc[leveloffset=+1]
include::questions/2-type-transform.adoc[leveloffset=+1]
