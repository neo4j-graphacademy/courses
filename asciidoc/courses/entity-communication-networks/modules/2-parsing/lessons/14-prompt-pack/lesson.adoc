...
**Course complete.** The next course, link:/courses/entity-extraction-communication-networks/[Entity Extraction: Communication Networks^], adds thread decomposition, chunking, and entity extraction.
