...
:status: draft
:duration: 2 hours
:caption: Extract structured communication metadata from documents and build entity networks in Neo4j
:categories: intermediate:1
:key-points: PDF extraction, Document parsing, LLM parsing, Hybrid pipelines, Neo4j import
