...
[.transcript]
In the world of graph data science, algorithms like ink:https://neo4j.com/docs/graph-data-science/current/algorithms/kmeans/[KMeans^] or link:https://neo4j.com/docs/graph-data-science/current/algorithms/knn/[K-Nearest Neighbors^]  rely on numerical data as inputs.
