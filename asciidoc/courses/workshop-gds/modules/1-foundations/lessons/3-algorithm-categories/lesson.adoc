...
image::images/diagram_showing_graph_requirements_for_algorithms_.png[Diagram showing graph requirements for algorithms: Leiden needs undirected, Pathfinding needs weighted, Node Similarity for bipartite graphs.]
