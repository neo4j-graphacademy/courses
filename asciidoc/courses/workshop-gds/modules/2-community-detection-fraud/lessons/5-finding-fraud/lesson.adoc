...
image::images/user_user_shared_card.svg[Two users both share a card, and have sent money to each other.]
...
But there's a problem: some identifiers
connect to hundreds of users, like coffee shop IP addresses, public library devices.
...
[.col]
====
image::images/high_degree_identifiers.svg[Illustration showing high-degree identifiers with many user connections, highlighting noise.]
====
