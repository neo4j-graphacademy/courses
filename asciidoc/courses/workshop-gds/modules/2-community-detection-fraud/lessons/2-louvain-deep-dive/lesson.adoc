...
image::images/community_detection_large.svg[A network divided into distinct communities, each highlighted in a different color.]
...
image::images/high_vs_low_modularity.svg[Diagram showing high vs low modularity in network connections.]
...
image::images/louvain_moves_nodes.svg[Left: A node in one community. Right: Same node moved to another community where it has more connections.]
...
Each node considers joining neighboring
communities.

It joins whichever community increases
modularity the most.

**Phase 2: Aggregation**

Once no more moves improve modularity,
it collapses each community into a
single "super-node"
and repeats Phase 1.
====
...
[.col]
====
image::images/louvain_two_phases.svg[Flowchart of Louvain algorithm's two phases: Local Optimization and Aggregation.]
====
...
image::images/louvain_hierarchy.svg[A diagram showing communities merging at successive levels.]
...
image::images/lovain_with_weights.svg[Diagram comparing weighted vs unweighted network relationships.]
