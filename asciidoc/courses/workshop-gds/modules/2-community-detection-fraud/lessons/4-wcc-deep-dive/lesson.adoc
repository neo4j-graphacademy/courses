...
image::images/louvain_and_wcc.svg[Comparison of Louvain, Degree Centrality, and WCC algorithms with labeled characteristics.]
...
image::images/degree_centrality.svg[A node has 5 outgoing relationships and three incoming relationships. Label reads "degree equals 5".]
...
[.col]
====
image::images/islands_bridges.svg[Seven islands. Those connected by bridges are labeled as single components.]
====
...
[.transcript-only]
====
With threshold: 5.0, only connections where actors shared more than 5 movies are considered. This breaks the giant component into smaller, more meaningful groups of frequent collaborators.
====
...
image::images/seeded_wcc.svg[Flowchart illustrating how seeded WCC works.]
...
----
MATCH (source:UserP2P)-[r:USED]->(:Device)<-[:USED]-(target:UserP2P)
RETURN gds.graph.project(
  'optimized-graph',
  source,
  target,
