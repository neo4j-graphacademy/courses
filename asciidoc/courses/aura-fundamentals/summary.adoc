...
* Understand the benefits of fully managed Neo4j Aura and self-managed Neo4j
...
=== Cost Management
* Start with **AuraDB Free** for experimentation and learning
...
You are now ready to deploy and manage Neo4j databases in the cloud using Aura!
