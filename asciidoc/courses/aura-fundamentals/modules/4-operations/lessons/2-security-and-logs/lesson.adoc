...
[.slide.discrete]
== Configuring security and logs


In the previous lesson, you learned about the different metrics available in Neo4j Aura and how to monitor the performance of your database instances.
...
[start=5]
. After you have completed these steps, confirm again by clicking the **Enable MFA** button.
...
Download logs for further analysis or compliance purposes.
...
[NOTE]
.Neo4j Aura Security Whitepaper
====
To learn more about enabling security features in Neo4j Aura, refer to the link:https://neo4j.com/books/neo4j-aura-security/[Neo4j Aura Security Whitepaper^] for a detailed overview of security measures and responsibilities in Aura.
====
...
include::questions/1-logs.adoc[leveloffset=+1]
