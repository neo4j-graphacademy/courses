...
[NOTE]
====
For a detailed overview of the security measures and responsibilities in Aura, link:https://neo4j.com/books/neo4j-aura-security/[refer to the Neo4j Aura Security Whitepaper^].
====
