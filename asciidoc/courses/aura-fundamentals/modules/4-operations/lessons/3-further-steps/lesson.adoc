...
In the previous lesson, you learned how to enable basic security features and access logs in Neo4j Aura.
...
* **AuraDB Free**: Community-based support through the Neo4j Community Forum
...
* **Getting support** - Support channels vary by tier, from community support (Free) to 24x7 premium support (Virtual Dedicated Cloud)
* **Service Level Agreements** - Business Critical and Virtual Dedicated Cloud tiers offer 99.95% uptime guarantees with service credits
