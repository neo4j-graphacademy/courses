...
In the previous lesson you have learned how to navigate the Aura Console and understand the organizational structure of instances, projects, and organizations.
...
Select **Aura Professional** to create a new professional instance.
