...
So far in this course, you have learned how to navigate the Aura Console and understand the organizational structure of instances, projects, and organizations.
