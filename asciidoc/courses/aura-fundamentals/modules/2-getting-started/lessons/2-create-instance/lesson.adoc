...
Some instance settings can only be configured at creation time (Day 0), while others can be changed later:

**Day 0 only (cannot be changed later)**:
...
In this lesson, you created your first Aura database instance and learned about initial vs later configuration options.
