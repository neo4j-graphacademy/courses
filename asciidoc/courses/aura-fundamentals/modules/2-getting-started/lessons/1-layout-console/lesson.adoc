...
== Navigating the Aura Console

In this lesson, you will learn how to navigate the Aura Console and understand the structure of organizations, projects, and instances.
...
The diagram shows how different users can have different access levels to organizations and projects.
====

[.col]
====
image::images/console-hierarchy.png[Console hierarchy showing organizations, projects, and instances with user access levels]
====
...
View and change your current organization and project settings in the top left corner.

By default, you are assigned to an organization named after your account, with a project called **My project**.
...
**Projects** group database instances together for easier management.
...
====
A user can belong to multiple organizations, which helps when working across different teams or companies. Switch between organizations using the dropdown in the top left corner of the console.
====


[.slide]
To access organization-level settings, click on the Organization title part of the project section at the top.
...
Update the organization name by clicking the pencil icon next to the organization name, typing the new name, and clicking the tick when done.
...
Under **Users**, manage who has access to the console for your organization. Paid tiers offer additional user management options.


[.slide.discrete]
[NOTE]
.Console access and database access
====
...
Manage control and permissions for database instances in project settings.
...
In the next lesson, you will practice creating an AuraDB instance and configuring it for your business needs.
