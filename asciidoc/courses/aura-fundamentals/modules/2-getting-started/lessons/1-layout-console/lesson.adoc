...
====
A user can belong to multiple organizations. This is useful when working across different teams or companies. Switch between organizations using the dropdown in the top left corner of the console.
====
