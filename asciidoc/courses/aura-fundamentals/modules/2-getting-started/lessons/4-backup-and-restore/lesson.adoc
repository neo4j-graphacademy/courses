...
* **Snapshot frequency and retention** - How different tiers (Free, Professional, Business Critical, Virtual Dedicated Cloud) handle automated and on-demand snapshots
