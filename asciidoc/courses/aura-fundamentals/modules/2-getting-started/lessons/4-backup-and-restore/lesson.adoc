...
* The instance must have enough capacity for the data; Aura Free has extra limits.
...
You learned how Aura backup and restore works:

* **Snapshot types and tiers** — Scheduled vs on-demand; frequency and retention by tier.
