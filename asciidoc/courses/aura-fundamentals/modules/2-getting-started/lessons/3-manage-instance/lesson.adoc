...
In the previous lesson, you learned how to create Aura instances and to understand the key factors that influence instance configuration.
...
[.slide]
=== Upgrading an AuraDB Free instance
...
On your instances page, **Upgrade** is a button on the instance card and allows you to change the instance to a higher tier.
...
[.slide.discrete]
== Upgrading to AuraDB Professional


[TIP]
.Upgrading to AuraDB Professional
====
You can upgrade to a trial AuraDB Professional, but upgrading to Business Critical tier requires adding payment information.
====

[.slide.discrete]
=== Configuring instance sizes

For **AuraDB Professional** and **AuraDB Business Critical** tiers, configure the instance size using the **Configure** button.
...
* Available on Business Critical and Virtual Dedicated Cloud tiers
