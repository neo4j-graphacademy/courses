...
====
You can upgrade to a trial Aura Professional tier, but upgrading to Business Critical tier requires adding payment information. 
====
...
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/click-configure.mp4[role="cdn", Configure Instance, 350, 300]

On the configuration screen, you have the option to select different memory settings, as well as the price associated with each of them, and other advanced settings for specialised workloads. This screen also allows you to rename your instance, change thenumber of CPUs and the storage space.

image::images/configure-instance-size.jpg[Configure instance size,width=450,align=center]

You can edit instance details through the Configuration screen: 

video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/configure-details.mp4[role="cdn",  Configure Details, 350, 300]
