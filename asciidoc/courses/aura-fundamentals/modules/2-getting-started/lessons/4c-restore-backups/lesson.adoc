...
In the previous lesson, you learned how to create and manage snapshots, including exporting them and creating new instances.
...
**Why restore for your recommendation engine:** If you accidentally delete movie data or make changes that break your recommendation queries, restoring from a snapshot lets you recover quickly.
...
**Why this matters:** If you exported a snapshot earlier or have a backup from another Neo4j instance, you can restore it to your Aura instance.
...
**Why this matters:** Restore capabilities ensure you can recover your recommendation engine from data issues, accidental deletions, or problematic changes. A well-planned backup strategy protects your data and meets compliance requirements.

**How it works:** Restoring overwrites your current instance data with the backup data. Snapshots restore quickly from Aura's cloud storage, while local file restores require uploading the backup file first.
