...
* Set up your first **AuraDB Professional** instance (recommended)
...
For paid Aura tiers, choose from multiple cloud providers (AWS, GCP, Azure) and regions within those providers. **AuraDB Free** is limited to Google Cloud Platform (GCP) in the us-central1 region.
...
[.slide]
== Step 4: Set Up Your First AuraDB Professional Instance

After setting up your account, you will be directed to the region and cloud provider selection page. In this example, you are learning about starting with **AuraDB Professional** to access the complete feature set.

**AuraDB Professional** includes:
...
Click **Start 14 days free trial** to begin with **AuraDB Professional**:
...
When sizing a graph database, except for **AuraDB Free**, you need to consider two main components:
...
For **AuraDB Free**, size choices are hidden from you, but the database limits (200,000 nodes and 400,000 relationships) typically need between 3GB and 4GB of storage.
...
After completing the setup, the Aura console displays your Getting Started page for your new **AuraDB Professional** instance:
...
[.slide]
== Alternative: AuraDB Free

If you chose **AuraDB Free** instead of **AuraDB Professional**, you will have access to a fixed configuration:
...
To access **AuraDB Free**, click "Select another instance" on the region selection page:
