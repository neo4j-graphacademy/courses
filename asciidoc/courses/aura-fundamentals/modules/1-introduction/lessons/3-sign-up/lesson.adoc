...
Unless all this information is available, estimate based on your best projections. This is less of a problem for Aura since database instances are resizable through the Aura console with a few clicks.
