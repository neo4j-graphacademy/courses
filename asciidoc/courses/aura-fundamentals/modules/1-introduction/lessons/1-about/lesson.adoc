...
Neeo4j Aura is a fully managed cloud graph database service that allows you to run multiple Neo4j instances as opposed to self-managed Neo4j which runs on-prem.
...
Aura provides a fully managed Neo4j database service, which means you don't have to worry about the underlying infrastructure, maintenance, or operations. You can deploy Neo4j instances in the cloud and scale them as needed without the having to manage servers, backups, or updates.
