...
* **Service Level Agreements**: 99.95% uptime SLA with fault tolerance and high availability (Business Critical and Virtual Dedicated Cloud tiers). See the link:https://neo4j.com/legal-terms/neo4j-sla/[Neo4j SLA^] for details.
