...
You can use Aura Professional when you need more storage space, want to choose your cloud provider (AWS, GCP, or Azure), and need daily backups.
...
In the next module, you will learn how to create your first Aura instance.
