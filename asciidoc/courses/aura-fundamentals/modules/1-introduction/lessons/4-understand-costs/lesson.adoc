...
In the previous lessons, you learned about the different tiers available on Neo4j Aura and how to select the right tier for your specific use case.
...
* **Security**: Encryption at rest and in transit, role-based access control, and network isolation.
...
* **Right-tier selection**: Select the appropriate tier based on your application's needs. For example, use **AuraDB Free** for development and testing, and **AuraDB Professional** or **AuraDB Business Critical** for production workloads.
...
**AuraDB Free** instances:

* Cannot be manually paused
* Auto-pause after 72 hours of inactivity
* Deleted after 30 days of being paused

**AuraDB Professional** / **AuraDB Business Critical** / **AuraDB Virtual Dedicated Cloud** instances:
...
Here are some tips to help you make informed decisions about using Aura:
