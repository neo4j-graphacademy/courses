...
So far in this course, you have learned about the different tiers available on Neo4j Aura and how to select the right tier for your specific use case.
...
For paid tiers (Professional, Business Critical, VDC):
