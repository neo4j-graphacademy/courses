...
// [ ] Consider splitting into 2 lessons: "Inspect and Configure" + "Backup Limitations" 
...
// [ ] Remove unused image reference: 03_aura_console_organization_structure.png
// [ ] Consider adding a hands-on challenge section to prepare for next lesson

= Manage an instance

Now that you've successfully created your first Aura instance, you'll want to know how to manage it effectively.
...
There is a difference between **managing the instances** and **managing the data**. Your infrastructure team (including DBAs) handles instance management - and with great power comes great responsibility.
...
Let's explore the most important operations you'll use regularly.
...
This panel also allows you to view and take snapshots and restore the database from a backup.  We will cover this in more detail in the next lesson.
...
You can update the instance to a higher tier by clicking the **Upgrade** button.
