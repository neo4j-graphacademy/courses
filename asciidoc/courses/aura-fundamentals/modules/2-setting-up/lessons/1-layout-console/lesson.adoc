...
That sounds like a graph, doesn't it?
...
You understand that organizations contain projects, and projects contain database instances. 
You also learned that console access is separate from database access security.

In the next lesson, you will create your first Aura database instance and configure it for your needs.
