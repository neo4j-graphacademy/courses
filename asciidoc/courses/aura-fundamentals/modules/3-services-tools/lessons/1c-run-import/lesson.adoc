...
In the previous lesson, you created your graph data model with Movie and Person nodes connected by ACTED_IN relationships.

**Your mission in this lesson:** Run the import to load your movie data into Aura and verify that everything was imported correctly. Once complete, your recommendation engine will have the data it needs to find connections between movies and actors.
...
In this lesson, you completed the import process for your recommendation engine. You:
