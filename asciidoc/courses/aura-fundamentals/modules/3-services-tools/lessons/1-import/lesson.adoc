...
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/edit-fields.mp4[role="cdn",  Edit Fields, 350, 300]
...
Proceed to giving your data model a name and **Save** it, in this case "Movies Model
