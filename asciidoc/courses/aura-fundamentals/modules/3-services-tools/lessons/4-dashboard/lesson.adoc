...
You will build a dashboard that visualizes actor relationships in the movie database.
...
In this lesson, you learned how to create interactive dashboards in Aura.

You now know how to build dashboard cards with Cypher queries and add filters to make your dashboards dynamic and user-friendly.
