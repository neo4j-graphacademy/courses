...
Each tool serves a different purpose in your data workflow:
...
|**Query**
|Development, debugging, administration, precise Cypher work

|**Explore**
|Visual discovery, business user exploration, sharing via Perspectives

|**Dashboards**
|Stakeholder reporting, KPIs, self-service analytics, presentations
|===

These tools complement each other. A typical workflow might be:

1. **Query** - Develop and test your Cypher queries
2. **Explore** - Validate results visually and create Perspectives for business users
3. **Dashboards** - Package insights for stakeholders who need regular access
