...
In the previous lessons, you learned how to execute Cypher queries using the Query tool and explore your data using the Explore tool.
...
In the next lesson, you will learn how to compare and choose the right tool for different tasks.
