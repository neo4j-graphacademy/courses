...
**What this video shows:** How to access the edit interface for an existing dashboard card.
...
**What happened:** The previous video showed how to open the edit interface. After making changes to your card (updating the query, changing visualization type, or adjusting filters), you need to save those changes.

**What this video shows:** How to save your card changes and update the dashboard.
...
[.slide.col-2]
== Query vs Explore vs Dashboards
