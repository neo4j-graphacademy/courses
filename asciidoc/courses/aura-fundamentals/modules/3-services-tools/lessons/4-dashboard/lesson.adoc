...
====
The integrated Dashboards tool was formerly known as Neodash and is now fully integrated into the Aura console for seamless access.
====
[.slide][.col=2]
...
For more information about the integrated Dashboards tool, see the [Neo4j Aura documentation](https://neo4j.com/docs/aura-user-guide/current/dashboards).
