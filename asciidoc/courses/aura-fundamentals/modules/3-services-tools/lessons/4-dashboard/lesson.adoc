...
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/create-edit-dashboard.mp4[role="cdn",  Create and Edit Dashboard, 350, 300]
...
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/create-dashboard-with-ai.mp4[role="cdn", Generate Dashboard with AI, 350, 300]
...
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/new-card-ai.mp4[role="cdn", Create New Card with AI, 350, 300]
...
You can also generate a card using AI by clicking the "Generate with AI" button. This will prompt you to enter a description of the data you want to visualize, and the AI will create a card based on your input:

video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/new-card-ai.mp4[role="cdn",  Generate Card with AI, 350, 300]
...
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/edit-card.mp4[role="cdn", Edit Card, 350, 300]


Make the changes you want, then click **Save changes** to update the card. 

video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/save-card.mp4[role="cdn", Save Card, 350, 300]
...
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/dashboards-long-version.mp4[role="cdn",  Dashboard Prototyping, 350, 300]
