...
**Why use Data Importer?** Instead of writing complex import scripts, visually map your CSV data to graph nodes and relationships. The Data Importer provides a visual interface that makes it easy to transform tabular data into a graph structure.
