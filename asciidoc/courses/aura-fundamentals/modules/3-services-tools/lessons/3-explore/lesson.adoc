...
The **Explore** tool provides a visual interface for exploring your graph data. It allows you to interact with your data without needing to write Cypher queries. You can search for nodes and relationships, visualize them, and even edit the graph directly.
...
[.slide]
== Visualizing results
The results are visualized in the scene area. You can interact with the nodes and relationships by clicking and dragging them around.
...
For more information on how to use the **Explore** tool, you can refer to the link:https://neo4j.com/docs/aura/explore/introduction/[Neo4j Aura documentation^].
