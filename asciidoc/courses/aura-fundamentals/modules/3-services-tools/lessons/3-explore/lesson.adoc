...
The **Explore** tool provides a visual interface for exploring your graph data without writing Cypher queries. Search for nodes and relationships, visualize them, and edit the graph directly.

Use link:https://explore.neo4j.io[Neo4j Bloom^] as a standalone application by connecting with your credentials and connection URL.

[.slide]
== Explore tool overview

**What this video shows:** An overview of the Explore tool's options and how to access different exploration features.
...
**What this video shows:** The Explore tool interface and how to navigate the visual graph exploration features.
...
**What this video shows:** How to explore nodes visually by clicking on them to expand relationships and discover connections in your graph.

video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/explore-nodes.mp4["Explore Nodes",role="cdn", width=100%]

**What happened:** The video demonstrated node exploration. You can click on any node to see its relationships and connected nodes, enabling visual discovery of your recommendation engine's data structure.
...
**What this video shows:** Additional exploration options available in the Explore tool, including filtering and perspective creation.
...
.Important considerations
====
1. The model has to be understood. Explore the data knowing what the database holds and how it is organized.
