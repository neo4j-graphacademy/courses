...
* Visualizing relationships between nodes
* Understanding connection patterns
* Small to medium result sets (up to a few hundred nodes)

**Table view** - Best for:

* Aggregated results (counts, sums, averages)
* Property comparisons across nodes
* Exporting data for further analysis

**Text/JSON view** - Best for:

* Debugging query results
* Copying data programmatically
* Viewing raw property values
...
For more information on the Query tool and Cypher syntax, see the link:hthttps://neo4j.com/docs/aura/query/introduction/[Neo4j Aura Query documentation^] and the link:https://neo4j.com/docs/cypher-manual/current/[Cypher Manual^].
