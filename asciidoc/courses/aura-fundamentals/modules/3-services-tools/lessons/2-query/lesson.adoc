...
== Create query blocks using AI

You can also create query blocks using AI by clicking the "Generate with AI" button. This will prompt you to enter a description of the data you want to query, and the AI will generate a Cypher query based on your description:

video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/generate-query-ai.mp4[role="cdn", Generate Query AI, 350, 300]
...
You can use the GenAI Query builder to create a query that returns all nodes and relationships in the database:
video::https://cdn.graphacademy.neo4j.com/courses/aura-fundamentals/genai-query-builder.mp4[role="cdn",  GenAI Query Builder, 350, 300]
