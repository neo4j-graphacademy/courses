...
So far in this course, you have learned how to import and verify your movie data in your Aura instance, creating a graph with Person and Movie nodes connected by ACTED_IN relationships.
...
**Why these patterns matter:** These query patterns demonstrate fundamental graph traversal concepts:
