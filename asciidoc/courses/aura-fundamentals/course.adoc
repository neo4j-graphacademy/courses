...
This course will prepare you to deploy and manage Neo4j databases in the cloud.
...
Before starting this course, you should have a basic understanding of graph databases and some familiarity with Neo4j. If you are new to Neo4j, familiarize yourself with the database through the link:/courses/neo4j-fundamentals/[Neo4j Fundamentals course^].
