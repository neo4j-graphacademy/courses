...
.Hint
====
Think about which tables represent real business entities versus which exist only for technical reasons in the relational model.
====
...
* **Small lookup tables with static values** - These can become node labels or properties instead. Example: Priority levels ("High", "Medium", "Low") can be a property on the node.
