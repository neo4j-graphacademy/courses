...
* A Neo4j AuraDB Professional instance (no credit card required), or GraphAcademy Sandbox, or Self-Managed Neo4j
* The Northwind CSV files (instructions below), or optional PostgreSQL with Northwind for the full relational-to-graph workflow
...
.Quick start
====
The import process is covered in Module 3. Use these CSV files with the Data Importer or Cypher in your Neo4j instance.
====
