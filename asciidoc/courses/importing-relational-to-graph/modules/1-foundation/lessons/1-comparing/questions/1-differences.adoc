[.question]
= Understanding relational vs graph models
...
.Hint
====
Think about how relationships are represented and accessed in each model. Consider whether relationships are stored directly or need to be computed.
====
