...
In Module 1 you defined how you would measure a meaningful import (node counts, relationship counts, property and referential integrity, sample queries). Here you run **those same scenarios** to verify your imported graph.

Use this test plan whether you used your own data or the Northwind sample. Visual inspection alone cannot detect missing records, broken relationships, or data type errors.
...
If you used the Northwind sample, expected counts are:
...
====
Bookmark this lesson. The validation test plan and queries apply to any relational-to-graph migration. Adapt the specific counts and property names to your own source data.
====
