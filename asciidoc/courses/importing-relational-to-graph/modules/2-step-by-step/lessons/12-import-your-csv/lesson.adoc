...
+
Use your own file or export from your relational database. If you prefer a sample to try first, the link:https://github.com/neo4j-graph-examples[Neo4j graph examples^] repo includes Northwind and other datasets.
