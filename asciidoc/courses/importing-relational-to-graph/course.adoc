...
:key-points: Migrating from relational to graph databases, Transforming SQL data models, Using the Neo4j Data Importer, Working with PostgreSQL and Northwind


== Course Description

In this course, you will learn how to migrate data from relational databases into Neo4j.
