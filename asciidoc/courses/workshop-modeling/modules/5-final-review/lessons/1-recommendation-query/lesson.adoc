...
1. Download link:https://cdn.graphacademy.neo4j.com/courses/workshop-modeling/modules/5-final-review/lessons/1-recommendation-query/data/complete-model.zip[complete-model.zip^]
