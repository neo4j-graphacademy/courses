...
* **Recommendation query** - 12 lines of Cypher compared to 38 lines of SQL
...
[.col]
====
A Neo4j instance has been created for you to use throughout this workshop.
...
====
[TIP]
.Integrated Query pane
=====
You can open the Query pane throughout this course by clicking the link:#[Toggle Query pane,role=classroom-sandbox-toggle] button in the bottom right hand corner of the screen.
