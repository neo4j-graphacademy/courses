...
Now that you know how the Import tool works, let's import all the data files at once. You'll load everything upfront, then model and import nodes step by step.
