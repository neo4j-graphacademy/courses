...
....
graph LR
    O10248((Order 10248<br/>1996-07-04)) -->|"CONTAINS<br/>qty: 12"| P1((Queso<br/>Cabrales))
    O10248 -->|"CONTAINS<br/>qty: 10"| P2((Singaporean<br/>Hokkien Mee))
    O10248 -->|"CONTAINS<br/>qty: 5"| P3((Mozzarella<br/>di Giovanni))

    style O10248 fill:#7CCFA9
