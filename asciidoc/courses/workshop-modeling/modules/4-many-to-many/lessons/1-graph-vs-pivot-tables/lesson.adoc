...
**Key insight:** Each Order node can connect to multiple Product nodes. This is what makes graph queries fast - you traverse directly from order to products without any JOIN operations.
====
