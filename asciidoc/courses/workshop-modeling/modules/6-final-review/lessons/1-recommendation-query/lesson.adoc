...
You've built the core Customer→Order→Product graph.
...
====
This lesson works with the core graph (Customers, Orders, Products). If you completed the optional Module 5 lessons (Categories, Suppliers, Employees), that's great - but they're not required for recommendations.
