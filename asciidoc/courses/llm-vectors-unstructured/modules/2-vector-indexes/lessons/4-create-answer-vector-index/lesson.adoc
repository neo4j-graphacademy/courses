...
The `Answer` nodes have a `text` and `embedding` property. The `text` property contains the answer text, and the `embedding` property is the vector representation of the answer text.
