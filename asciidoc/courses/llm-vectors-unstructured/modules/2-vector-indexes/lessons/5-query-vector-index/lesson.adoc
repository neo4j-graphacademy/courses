...
You first need to get an embedding of the text. 
Then, you can use the embedding to query the vector index.
...
You can complete an optional challenge in the next lesson to test your skills and knowledge.
