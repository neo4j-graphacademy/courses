...
You may have to manually take the information from the email and put it into a structured format to analyze it.

== Challenges

Analyzing unstructured data presents various challenges due to its nature and characteristics. 
Here are some considerations why it's difficult:
...
They can help to visualize and understand the relationships and connections between different data points.
...
For example, using vectors to find the right documentation to support a customer query and using a graph to understand the relationships between different products and customer feedback.
...
In this lesson, you learned about unstructured data and the challenges it presents. 
