...
This link:{repository-link}[{repository}^] repository has been created for this course.
...
You can use a link:https://github.com/codespaces[GitHub codespace^] as an online IDE and workspace for this workshop.
...
Clone the link:{repository-link}[github.com/neo4j-graphacademy/llm-vectors-unstructured] repository:
