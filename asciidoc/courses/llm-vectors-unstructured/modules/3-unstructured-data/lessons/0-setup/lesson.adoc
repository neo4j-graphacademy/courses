...
We have created a link:https://github.com/{repository}[repository^] for this course.
...
Clone the link:https://github.com/{repository}[github.com/neo4j-graphacademy/llm-vectors-unstructured] repository:
