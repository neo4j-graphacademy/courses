...
View link:https://github.com/neo4j-graphacademy/courses/blob/main/asciidoc/courses/llm-vectors-unstructured/modules/3-unstructured-data/1-structured-unstructured/lesson.adoc?plain=1[this lesson's content on GitHub^] and note the following:
...
include::questions/1-metadata.adoc[leveloffset=+1]
