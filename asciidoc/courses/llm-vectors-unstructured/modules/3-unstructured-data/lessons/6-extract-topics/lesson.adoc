...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/extract_topics.py[]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph_topics.py[tag=import_textblob]

include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph_topics.py[tag=get_course_data]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph_topics.py[tag=create_chunk]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph_topics.py[tag=**]
----
====
