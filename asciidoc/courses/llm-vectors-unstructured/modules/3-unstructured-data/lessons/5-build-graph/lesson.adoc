...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/build_graph.py[]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=get_embedding]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=get_course_data]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=openai]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=neo4j]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=create_chunk]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=create]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=close]
----
...
[source]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/build_graph.py[tag=**]
----
====
