...
Update the program you created in the last lesson to extract topics from the lesson content and add them to the graph.
...
You can update the `get_course_data` function to extract topics from the lesson content.
...
The `create_chunk` function can also add the topics to the graph:
