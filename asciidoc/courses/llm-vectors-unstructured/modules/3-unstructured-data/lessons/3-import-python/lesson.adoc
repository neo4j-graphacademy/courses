...
[source,python]
----
include::{repository-raw}/main/llm-vectors-unstructured/create_vector.py[]
----
...
[source,python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=import_splitter]

include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=splitter]
----
...
[source,python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=split]
----
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=import_vector]

include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=vector]
----
...
[source]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=**]
----
====
