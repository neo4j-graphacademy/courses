...
[source,python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=importsplitter]
...
[source, python]
----
include::{repository-raw}/main/llm-vectors-unstructured/solutions/create_vector.py[tag=importvector]
