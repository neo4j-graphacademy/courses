...
* **Metrics Reader**: This is the only role that cannot view Dashboards, but has access to only view performance metrics and monitoring data for instances within a specific project. Cannot make any changes to the instance or settings.
