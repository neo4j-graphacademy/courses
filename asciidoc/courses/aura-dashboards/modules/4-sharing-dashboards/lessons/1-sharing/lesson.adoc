...
In the previous lessons, you learned how to create interactive dashboards that visualize movie recommendation insights using AI and Cypher queries.

In this lesson, you will learn how to:

* Share your movie recommendation dashboards with specific stakeholders (content teams, marketing, executives)
...
[.summary]
== Summary
In this lesson, you learned how to share your movie recommendation dashboards with stakeholders by inviting users to your project and dashboards as VIEWERS. You also learned about different user roles and their permissions, ensuring the right people have access to make data-driven decisions about content recommendations.

In the next lesson, you will learn about additional resources and next steps to continue building dashboards for your movie recommendation system.
