...
.Hint
====
Project Viewer provides read-only access to instances and dashboards. Users with this role can view dashboards but cannot modify them or access the database directly.
====
