...
For more information on how to use the **Explore** tool, see link:https://neo4j.com/docs/aura/explore/introduction/[the Neo4j Aura documentation^].
...
In the next lesson, you will learn how to create dashboards with Cypher queries and add filters to make them interactive.
