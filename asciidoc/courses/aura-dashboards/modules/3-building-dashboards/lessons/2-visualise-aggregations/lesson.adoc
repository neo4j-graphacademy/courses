...
* Connect to your Neo4j database using the integrated Explore tool
...
From your Dashboards interface, either go to **Instances** and select the database you want to connect to and use the **Connect** dropdown and select **Explore**, or go directly to **Explore** and use the Connect button from there.
...
If you have obtained a different value, don't worry! The data in your database may vary based on other activities you have performed.
