...
Create a bar chart card to visualize the number of movies directed per country:
...
Share your dashboard with your peers and discuss the choices you made for each visualization, or post it on the link:https://community.neo4j.com[Neo4j Community forum^].
