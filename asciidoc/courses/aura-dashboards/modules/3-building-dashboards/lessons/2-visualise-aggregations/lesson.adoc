...
In the previous lesson, you learned how to organize your dashboard structure.
...
The **Explore** tool provides an interface for visualizing and exploring your graph data. It allows you to interact with your data in a more intuitive way, without needing to write Cypher queries. Search for nodes and relationships, visualize them, and even edit the graph directly if you have write access to the instance.
...
== Explore
Once connected, start exploring your data without writing any Cypher.
...
====
Reuse the Cypher queries provided in this lesson to create multiple cards with different visualization types.
For example, create both a bar chart and a pie chart using the same query to visualize the distribution of movie ratings.
...
====
Security applies to dashboards based on the access control permissions assigned to users. Users will only see data they have permission to access.
====
...
In this lesson, you learned how to visualize your aggregated data using different visualization types in the Dashboards tool.

In the next lesson, you will learn how to:

* Share and publish your dashboards to stakeholders
* Collaborate and enable decision-making
