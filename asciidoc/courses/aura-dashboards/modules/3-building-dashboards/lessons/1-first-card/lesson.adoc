...
In this lesson, you will learn how to create your first card in Neo4j Aura Dashboards, using either the natural language AI assistant or by writing Cypher queries.

You will explore the different card types available and understand how to visualise your graph data effectively: 
...
* **Table**: Great for detailed data representation.

Optionally, you can dive into writing Cypher queries to fetch and visualise aggregated data, providing more control over the data displayed in your cards.
...
image::images/add-card.png[Add a card dialog,width=600,align=center]
