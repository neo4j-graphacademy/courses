...
Before you start, make sure you have completed the previous lesson and imported the sample data into your instance.

NOTE: The sample data should be _loaded_ into your instance using the provided Cypher script, not the Import service.
...
In this section, create your first card using the Query tool.
...
== Summary
TIP: 
In this lesson you learned how to use the Query tool to connect to your instance, execute Cypher queries, and visualize the results.
