...
This can be also found in the graph model generated after you have imported the movie dataset into your Neo4j database:

(Navigate to Imported Data > Graph Model in the Dashboards interface to view the graph model.)
...
You have been given a movie dataset and need to describe its data model. In your Neo4j database, identify the key entities, relationships, and properties that define the structure of the movie project.
...
In the next lesson, you will create your in-depth dashboard and configure it for your business needs in Neo4j.
