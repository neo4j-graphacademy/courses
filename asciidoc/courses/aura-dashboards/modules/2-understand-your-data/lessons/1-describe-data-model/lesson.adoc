...
* List the properties associated with each entity and relationship
...
* What are the main nodes and properties in your data?
...
* What are theq key metrics they want to track?
