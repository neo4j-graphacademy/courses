...
In Aura, you have access to an integrated AI tool that allows you to quickly prototype and build production-ready dashboards.
...
Before creating your dashboard, verify that you've loaded the sample movie data in your instance. The **Explore** tab should display nodes and relationships from the movie dataset.

image::images/explore-check.png[The Explore tab showing the loaded data graph]


Go to the **Dashboards** tab and click **Create with AI** to begin:

image::images/create-with-ai-button.png[dashboard_start,width=500,align=center]

In the prompt dialog, enter a description of the insights you want to visualize. As a good practice, be specific about the node and relationship labels to ensure accurate results. For example, you can enter a description like "Visualize actor relationships in movies." or simply "Actor relationships":
...
Try to replicate the following steps to create your first dashboard:
...
In the next lesson, you will learn how to describe your movie data model in Neo4j Aura and design dashboards that align with stakeholder requirements.
