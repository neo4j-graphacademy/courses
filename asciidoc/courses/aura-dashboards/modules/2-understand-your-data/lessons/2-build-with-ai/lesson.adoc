...
Build a dashboard that visualizes actor relationships in the movie instance.
...
In the prompt dialog, enter a description of the insights you want to visualize. As a good practice, be specific about the node labels and relationship types to ensure accurate results. For example, enter a description like "Visualize actor relationships in movies." or simply "Actor relationships":
