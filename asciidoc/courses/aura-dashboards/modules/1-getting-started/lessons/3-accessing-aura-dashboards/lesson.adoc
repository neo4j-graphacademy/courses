...
You can use the GraphAcademy instance you link:../2-add-dataset[added as a self-managed instance^].
...
.Dashboard limits
====
The number of dashboards you can create depends on your Aura tier. See link:https://neo4j.com/docs/aura/dashboards/managing-dashboards/[Managing dashboards^] more information.
