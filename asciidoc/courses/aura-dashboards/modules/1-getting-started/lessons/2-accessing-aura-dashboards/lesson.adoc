...
You can find your connection details by clicking the **...** menu next to your instance name and selecting **Inspect**, or use the credentials file downloaded when you created the instance.
====
...
[.summary]
== Summary
In this lesson, you learned how to access Neo4j Dashboards, including understanding dashboard limits per tier and connecting to your instance from the Dashboards UI.
