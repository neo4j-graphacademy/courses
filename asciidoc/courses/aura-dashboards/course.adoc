= Building Dashboard in Neo4j Aura
...
You will learn how to choose the right dashboard for your needs, create and manage database instances, import and visualise data, and understand operational best practices.

You will explore the Aura Dashboards, learn about different options when it comes to data representation, and discover the built-in tools for data exploration and visualisation.
