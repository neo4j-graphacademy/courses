...
Typically, you would follow these steps to construct the knoeledge graph:
...
+ 
You include a prompt that instructs the LLM to identify the entities and relationships in the text.
+
[source, text]
----
...
[
    ...
    },
    {
        ...
        "tail": "Java",
        "tail_type": "Programming Language",
    },
    ...
]
----
