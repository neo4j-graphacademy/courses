...
include::{repository-raw}/{branch}/examples/load_data.py[tag=**]
...
include::{repository-raw}/{branch}/examples/chunk_data.py[tag=**]

This code would split the text into paragraphs (i.e., every time there is a double newline `\n\n`).
...
include::{repository-raw}/{branch}/examples/vectorize_data.py[tag=**]
...
include::{repository-raw}/{branch}/examples/create_graph.py[tag=**]
