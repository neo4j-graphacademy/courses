...
[source,python]
----
include::{repository-raw}/{branch}/llm-knowledge-graph/solutions/create_kg.py[tag=allowed_nodes]
----
...
[source,python]
----
include::{repository-raw}/{branch}/llm-knowledge-graph/solutions/create_kg.py[tag=allowed_relationships]
----
...
[source,python]
----
include::{repository-raw}/{branch}/llm-knowledge-graph/solutions/create_kg.py[tag=properties]
----
...
images::images/structured-data-model.svg[Graph data model showing Course, Module, and Lesson nodes]
