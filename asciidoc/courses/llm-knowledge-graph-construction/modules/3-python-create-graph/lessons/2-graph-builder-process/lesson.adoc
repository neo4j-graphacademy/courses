...
include::{repository-raw}/{branch}/llm-knowledge-graph/snippets/load_data.py[tag=**]
...
include::{repository-raw}/{branch}/llm-knowledge-graph/llm-knowledge-graph/snippets/vectorize_data.py[tag=**]
