...
If you don't intend to come back and complete the course, mailto:graphacademy@neo4j.com[reply to this email] to let us know and we'll make sure that you don't receive another email from us.
