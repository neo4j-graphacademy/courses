...
** linl:{base_url}{progressTo1_link}[{progressTo1_title}]
ifdef::progressTo2_title[]
** linl:{base_url}{progressTo2_link}[{progressTo2_title}]
endif::progressTo2_title[]
ifdef::progressTo3_title[]
** linl:{base_url}{progressTo3_link}[{progressTo3_title}]
