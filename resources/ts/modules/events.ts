...
type UiEventType = 'sandbox-toggle' | 'support-toggle' | 'show-hint' | 'show-solution' | 'video-playing' | 'video-paused' | 'video-ended' | 'show-transcript' | 'show-video' | 'show-sidebar' | 'hide-sidebar'
