...
export const ATTRIBUTE_TSHIRT_FORM = 'tshirt-form'
export const ATTRIBUTE_TSHIRT_IMAGE = 'tshirt-image'
export const ATTRIBUTE_TSHIRT_PROVIDER = 'tshirt-provider'
export const ATTRIBUTE_TSHIRT_PRODUCT_ID = 'tshirt-product-id'
