...
type DatabaseEnrolment = Omit<
    IntermediateEnrolment,
    'createdAt' | 'completedAt' | 'failedAt' | 'availableAfter' | 'lastSeenAt'
> & {
    createdAt: string
...
export default async function getEnrolments(
    tx: ManagedTransaction,
    user: Partial<User>,
    property: ValidLookupProperty = 'sub',
    courseSlug?: string
): Promise<IntermediateEnrolment[]> {
